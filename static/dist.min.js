...
function showMessage(e, t) {
    ...
    n.find(".close.icon").click(closeClosestMessage),
    $("#messages-container").append(n),
    n.slideDown(300)
}
function api(e, t, n, i, o) {
    "function" == typeof t && (n = t, t = null),
    "boolean" == typeof i && (o = i, i = void 0);
    var r = "An error occurred while contacting the Ripple API. Please report this to a Ripple developer.";
    $.ajax({
        method: o ? "POST" : "GET",
        dataType: "json",
        url: hanayoConf.baseAPI + "/api/v1/" + e,
        data: o ? JSON.stringify(t) : t,
        contentType: o ? "application/json; charset=utf-8" : "",
        success: function (e) {
            if (200 != e.code) {
                if (e.code >= 400 && e.code < 500 && "function" == typeof i)
                    return void i(e);
                console.warn(e),
                showMessage("error", r)
            }
        ...
        error: function (e, t, n) {
            if (e.status >= 400 && e.status < 500 && "function" == typeof i)
                return void i(e.responseJSON);
            console.warn(e, t, n),
            showMessage("error", r)
        }
    })
...
function disableSimplepagButtons(e) {
    var t = $(".simplepag");
    page <= 1 ? t.find(".left.floated .item").addClass("disabled") : t.find(".left.floated .item").removeClass("disabled"),
    e ? t.find(".right.floated .item").addClass("disabled") : t.find(".right.floated .item").removeClass("disabled")
}
...
function getScoreMods(e, t) {
    var n = [];
    return 512 == (512 & e) && (e &= -65),
    16384 == (16384 & e) && (e &= -33),
    modsString.forEach(function (t, i) {
        (e & 1 << i) > 0 && n.push(t)
    }),
...
function timeFormat(e) {
    ...
    i = e % 60,
    o = "";
    return t > 0 ? (o += t + ":", n < 10 && (o += "0"), o += n + ":") : o += n + ":",
    i < 10 && (o += "0"),
    o += i
}
function query(e, t) {
...
function modifyObjectDynamically(e, t, n) {
    return 1 === t.length ? e[t[0]] = n : t.length > 1 && ("object" != typeof e[t[0]] && (e[t[0]] = {}), e[t[0]] = modifyObjectDynamically(e[t[0]], t.slice(1), n)),
    e
}
function T(e, t) {
    return void 0 !== t && void 0 !== t.count && -1 === $.inArray(hanayoConf.language, langWhitelist) && 1 !== t.count && (e = keyPlurals[e]),
    i18next.t(e, t)
}
...
("undefined" != typeof window ? window : this, function (e, t) {
    ...
    function d() {
        Y.removeEventListener("DOMContentLoaded", d),
    ...
    function m(e, t, n, i) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; a--; )
                ge.style(e, t, u + c), (1 - r) * (1 - (r = s() / l || .5)) <= 0 && (a = 0), u /= r;
            u *= 2,
            ge.style(e, t, u + c),
            n = n || []
        }
    ...
    function x(e, t, n, o, r) {
        for (var a, s, l, c, u, d, f = t.createDocumentFragment(), p = [], g = 0, h = e.length; g < h; g++)
            if ((a = e[g]) || 0 === a)
                if ("object" === i(a))
                    ge.merge(p, a.nodeType ? [a] : a);
                else if (Ge.test(a)) {
                    for (s = s || f.appendChild(t.createElement("div")), l = (_e.exec(a) || ["", ""])[1].toLowerCase(), c = Ke[l] || Ke._default, s.innerHTML = c[1] + ge.htmlPrefilter(a) + c[2], d = c[0]; d--; )
                        s = s.lastChild;
                    ge.merge(p, s.childNodes),
                    (s = f.firstChild).textContent = ""
                } else
                    p.push(t.createTextNode(a));
        for (f.textContent = "", g = 0; a = p[g++]; )
            if (o && -1 < ge.inArray(a, o))
                r && r.push(a);
        ...
        n ? (Pe.set(e, t, !1), ge.event.add(e, t, {
                ...
                handler: function (e) {
                    ...
                    if (1 & e.isTrigger && this[t]) {
                        ...
                        else if (r = ee.call(arguments), Pe.set(this, t, r), i = n(this, t), this[t](), r !== (o = Pe.get(this, t)) || i ? Pe.set(this, t, !1) : o = {}, r !== o)
                            return e.stopImmediatePropagation(), e.preventDefault(), o.value
                    } else
                        r.length && (Pe.set(this, t, {
    ...
    function R(e, t, i, o) {
        ...
        g = t[0],
        h = ue(g);
        if (h || 1 < f && "string" == typeof g && !ce.checkClone && it.test(g))
            return e.each(function (n) {
                var r = e.eq(n);
                h && (t[0] = g.call(this, n, r.html())),
                R(r, t, i, o)
            });
        if (f && (a = (r = x(t, e[0].ownerDocument, !1, e, o)).firstChild, 1 === r.childNodes.length && (r = a), a || o)) {
            for (l = (s = ge.map(b(r, "script"), E)).length; d < f; d++)
                c = r, d !== p && (c = ge.clone(c, !0, !0), l && ge.merge(s, b(c, "script"))), i.call(e[d], c, d);
            if (l)
                for (u = s[s.length - 1].ownerDocument, ge.map(s, j), d = 0; d < l; d++)
                    c = s[d], Xe.test(c.type || "") && !Pe.access(c, "globalEval") && ge.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? ge._evalUrl && !c.noModule && ge._evalUrl(c.src, {
    ...
    function O(e, t, n) {
        for (var i, o = t ? ge.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
            n || 1 !== i.nodeType || ge.cleanData(b(i)), i.parentNode && (n && $e(i) && y(b(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    function P(e, t, n) {
        var i,
        ...
        a,
        s = e.style;
        return (n = n || at(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || $e(e) || (a = ge.style(e, t)), !ce.pixelBoxStyles() && rt.test(a) && st.test(t) && (i = s.width, o = s.minWidth, r = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = o, s.maxWidth = r)),
        void 0 !== a ? a + "" : a
    }
    function L(e, t) {
        return {
    ...
    function F(e, t, n, i, o, r) {
        ...
        if (n === (i ? "border" : "content"))
            return 0;
        for (; a < 4; a += 2)
            "margin" === n && (l += ge.css(e, n + Ie[a], !0, o)), i ? ("content" === n && (l -= ge.css(e, "padding" + Ie[a], !0, o)), "margin" !== n && (l -= ge.css(e, "border" + Ie[a] + "Width", !0, o))) : (l += ge.css(e, "padding" + Ie[a], !0, o), "padding" !== n ? l += ge.css(e, "border" + Ie[a] + "Width", !0, o) : s += ge.css(e, "border" + Ie[a] + "Width", !0, o));
    ...
    function M(e, t, n) {
        ...
        return (!ce.boxSizingReliable() && o || "auto" === a || !parseFloat(a) && "inline" === ge.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === ge.css(e, "boxSizing", !1, i), (r = s in e) && (a = e[s])),
        (a = parseFloat(a) || 0) + F(e, t, n || (o ? "border" : "content"), r, i, a) + "px"
    }
    ...
    function V(e, t, n) {
        ...
        l = function () {
            if (o)
                return !1;
            for (var t = ht || $(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++)
                c.tweens[r].run(i);
        ...
        for ((!function (e, t) {
                ...
                for (n in e)
                    ...
                    (u, c.opts.specialEasing)); r < a; r++)if (i = V.prefilters[r].call(c, e, u, c.opts))
                return ue(i.stop) && (ge._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return ge.map(u, U, c),
    ...
    ge.extend = ge.fn.extend = function () {
        ...
        for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || ue(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    i = e[t], "__proto__" !== t && a !== i && (c && i && (ge.isPlainObject(i) || (o = Array.isArray(i))) ? (n = a[t], r = o && !Array.isArray(n) ? [] : o || ge.isPlainObject(n) ? n : {}, o = !1, a[t] = ge.extend(c, r, i)) : void 0 !== i && (a[t] = i));
        return a
    },
    ge.extend({
        ...
        makeArray: function (e, t) {
            var n = t || [];
            return null != e && (o(Object(e)) ? ge.merge(n, "string" == typeof e ? [e] : e) : ne.call(n, e)),
            n
        },
    ...
    "function" == typeof Symbol && (ge.fn[Symbol.iterator] = G[Symbol.iterator]),
    ...
    var me = function (e) {
            ...
            if (!i && ((t ? t.ownerDocument || t : M) !== D && j(t), t = t || D, O)) {
                if (11 !== g && (l = he.exec(e)))
                    if (o = l[1]) {
                        if (9 === g) {
                            ...
                            if (a.id === o)
                                return n.push(a), n
                        } else if (p && (a = p.getElementById(o)) && N(t, a) && a.id === o)
                            return n.push(a), n
                    } else {
                        if (l[2])
                ...
                if (b.qsa && !V[e + " "] && (!P || !P.test(e)) && (1 !== g || "object" !== t.nodeName.toLowerCase())) {
                    if (f = e, p = t, 1 === g && se.test(e)) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(ye, xe) : t.setAttribute("id", s = F), r = (u = C(e)).length; r--; )
                            u[r] = "#" + s + " " + d(u[r]);
                        f = u.join(","),
        ...
        function n() {
            ...
            return function t(n, i) {
                return e.push(n + " ") > y.cacheLength && delete t[e.shift()],
                t[n + " "] = i
            }
        }
        function i(e) {
            ...
            return t.first ? function (t, n, o) {
             ...
             : function (t, n, l) {
                ...
                if (l) {
                    ...
                    for (; t = t[i]; )
                        if (1 === t.nodeType || a)
                            if (u = (d = t[F] || (t[F] = {}))[t.uniqueID] || (d[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase())
                                t = t[i] || t;
                            else {
                                if ((c = u[r]) && c[0] === I && c[1] === s)
                                    return f[2] = c[2];
                                if ((u[r] = f)[2] = e(t, n, l))
                                    return !0
                            }
        ...
        function h(e, n, o, r, a, s) {
            ...
            i(function (i, s, l, c) {
                ...
                y = o ? a || (i ? e : m || r) ? [] : s : b;
                if (o && o(b, y, l, c), r)
                    for (u = g(y, h), r(u, [], l, c), d = u.length; d--; )
                        (f = u[d]) && (y[h[d]] = !(b[h[d]] = f));
                if (i) {
                    if (a || e) {
                        if (a) {
                        ...
                        for (d = y.length; d--; )
                            (f = y[d]) && -1 < (u = a ? G(i, f) : p[d]) && (i[u] = !(s[u] = f))
                    }
                } else
                    y = g(y === s ? y.splice(m, y.length) : y), a ? a(null, s, y, c) : Q.apply(s, y)
            })
        }
        function m(e) {
        ...
        try {
            Q.apply(_ = J.call(M.childNodes), M.childNodes),
            _[M.childNodes.length].nodeType
        } catch (v) {
            Q = {
        ...
        for (v in b = t.support = {}, w = t.isXML = function (e) {
            ...
            return i !== D && 9 === i.nodeType && i.documentElement && (R = (D = i).documentElement, O = !w(D), M !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), b.attributes = o(function (e) {
                ...
                if ("*" === e) {
                    ...
                    if (void 0 !== t.getElementsByClassName && O)
                        return t.getElementsByClassName(e)
                            ...
                            e.querySelectorAll("[msallowcapture^='']").length && P.push("[*^$]=" + Z + "*(?:''|\"\")"),
                            e.querySelectorAll("[selected]").length || P.push("\\[" + Z + "*(?:value|" + Y + ")"),
                            ...
                            e.querySelectorAll("[name=d]").length && P.push("name" + Z + "*[*^$|!~]?="),
                    ...
                    l = [t];
                    if (!o || !r)
                        return e === D ? -1 : t === D ? 1 : o ? -1 : r ? 1 : A ? G(A, e) - G(A, t) : 0;
                    if (o === r)
                        return a(e, t);
                ...
                if ((e.ownerDocument || e) !== D && j(e), b.matchesSelector && O && !V[n + " "] && (!L || !L.test(n)) && (!P || !P.test(n)))
                    try {
                        var i = q.call(e, n);
                ...
                i = n && B.call(y.attrHandle, t.toLowerCase()) ? n(e, t, !O) : void 0;
                ...
                return n
                        ...
                        filter: {
                                 ...
                                 : function (t, n, l) {
                                    ...
                                    if (m) {
                                        ...
                                        if (g = [a ? m.firstChild : m.lastChild], a && b) {
                                            ...
                                            for (; (f = ++p && f && f[h] || (y = p = 0) || g.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++y || (b && ((u = (d = f[F] || (f[F] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [I, y]), f !== t)); );
                            ...
                            PSEUDO: function (e, n) {
                                var o,
                                r = y.pseudos[e] || y.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);
        ...
        C = t.tokenize = function (e, n) {
            ...
            for (s = e, l = [], c = y.preFilter; s; ) {
                for (a in i && !(o = re.exec(s)) || (o && (s = s.slice(o[0].length) || s), l.push(r = [])), i = !1, (o = ae.exec(s)) && (i = o.shift(), r.push({
                            value: i,
                            type: o[0].replace(oe, " ")
                        }), s = s.slice(i.length)), y.filter)
                    !(o = ue[a].exec(s)) || c[a] && !(o = c[a](o)) || (i = o.shift(), r.push({
                            value: i,
                            type: a,
                            matches: o
                        }), s = s.slice(i.length));
                ...
                (f = U(e, (r = d, s = 0 < (a = u).length, l = 0 < r.length, c = function (e, n, i, o, c) {
                                ...
                                if (p += h, s && h !== p) {
                                    ...
                                    if (e) {
                                        if (0 < p)
                                            for (; h--; )
                                                m[h] || v[h] || (v[h] = X.call(o));
                                        v = g(v)
                                    }
                                    Q.apply(o, v),
                                    c && !e && 0 < v.length && 1 < p + a.length && t.uniqueSort(o)
                                }
                                return c && (I = w, S = b),
                                m
                            }, s ? i(c) : c))).selector = e
        ...
        T = t.select = function (e, t, n, i) {
            ...
            if (n = n || [], 1 === f.length) {
                if (2 < (r = f[0] = f[0].slice(0)).length && "ID" === (a = r[0]).type && 9 === t.nodeType && O && y.relative[r[1].type]) {
                    if (!(t = (y.find.ID(a.matches[0].replace(ve, be), t) || [])[0]))
                        return n;
                    u && (t = t.parentNode),
            ...
            return (u || k(e, f))(i, t, !O, n, !t || me.test(e) && c(t.parentNode) || t),
            n
        },
    ...
    (ge.fn.init = function (e, t, n) {
        ...
        if (n = n || we, "string" == typeof e) {
            if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : Ce.exec(e)) || !i[1] && t)
    ...
    ge.each({
        ...
        ge.fn[e] = function (n, i) {
            ...
            1 < this.length && (Te[e] || ge.uniqueSort(o), ke.test(e) && o.reverse()),
            this.pushStack(o)
        }
    });
    var Se = /[^\x20\t\r\n\f]+/g;
        ...
        f = {
            ...
            remove: function () {
                return ge.each(arguments, function (e, t) {
                    for (var n; -1 < (n = ge.inArray(t, l, n)); )
                        l.splice(n, 1), n <= u && u--
                }),
                this
            },
            ...
            fireWith: function (e, t) {
                return s || (t = [e, (t = t || []).slice ? t.slice() : t], c.push(t), o || d()),
                this
            },
            fire: function () {
    ...
    ge.extend({
                        ...
                        d = function () {
                            ...
                            if (!(t < a)) {
                                if ((e = i.apply(s, u)) === n.promise())
                                    ...
                                    ue(d) ? o ? d.call(e, r(a, n, l, o), r(a, n, c, o)) : (a++, d.call(e, r(a, n, l, o), r(a, n, c, o), r(a, n, l, n.notifyWith))) : (i !== l && (s = void 0, u = [e]), (o || n.resolveWith)(s, u))
                                }
                            },
                            f = o ? d : function () {
                                try {
                                    ...
                                    ge.Deferred.exceptionHook && ge.Deferred.exceptionHook(e, f.stackTrace),
                                    a <= t + 1 && (i !== c && (s = void 0, u = [e]), n.rejectWith(s, u))
                                }
                            };
        ...
        when: function (e) {
            ...
            if (t <= 1 && (u(e, r.done(a(n)).resolve, r.reject, !t), "pending" === r.state() || ue(o[n] && o[n].then)))
                return r.then();
            for (; n--; )
                u(o[n], a(n), r.reject);
            return r.promise()
    ...
    ge.ready.then = Ee.then,
    "complete" === Y.readyState || "loading" !== Y.readyState && !Y.documentElement.doScroll ? e.setTimeout(ge.ready) : (Y.addEventListener("DOMContentLoaded", d), e.addEventListener("load", d));
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (o = Le.get(r), 1 === r.nodeType && !Pe.get(r, "hasDataAttrs"))) {
                    for (n = a.length; n--; )
                        a[n] && 0 === (i = a[n].name).indexOf("data-") && (i = p(i.slice(5)), h(r, i, o[i]));
            ...
            return "object" == typeof e ? this.each(function () {
                ...
                var n;
                if (r && void 0 === t)
                    return void 0 !== (n = Le.get(r, e)) ? n : void 0 !== (n = h(r, e)) ? n : void 0;
                this.each(function () {
                    Le.set(this, e, t)
                })
    ...
    ge.extend({
        queue: function (e, t, n) {
            var i;
            if (e)
                return t = (t || "fx") + "queue", i = Pe.get(e, t), n && (!i || Array.isArray(n) ? i = Pe.access(e, t, ge.makeArray(n)) : i.push(n)), i || []
        },
    ...
    ge.fn.extend({
        ...
        promise: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--; )
                (n = Pe.get(r[a], e + "queueHooks")) && n.empty && (i++, n.empty.add(s));
            return s(),
            o.promise(t)
        }
    });
    ...
    Je,
    Ge = /<|&#?\w+;/;
    Qe = Y.createDocumentFragment().appendChild(Y.createElement("div")),
    (Je = Y.createElement("input")).setAttribute("type", "radio"),
    ...
    ge.event = {
        ...
        add: function (e, t, n, i, o) {
            ...
            if (m)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && ge.find.matchesSelector(He, o), n.guid || (n.guid = ge.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function (t) {
                    ...
                    }), c = (t = (t || "").match(Se) || [""]).length; c--; )
                    p = h = (s = et.exec(t[c]) || [])[1], g = (s[2] || "").split(".").sort(), p && (d = ge.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = ge.event.special[p] || {}, u = ge.extend({
                            type: p,
                            origType: h,
                            data: i,
                            handler: n,
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(Se) || [""]).length; c--; )
                    if (p = h = (s = et.exec(t[c]) || [])[1], g = (s[2] || "").split(".").sort(), p) {
                        for (d = ge.event.special[p] || {}, f = l[p = (i ? d.delegateType : d.bindType) || p] || [], s = s[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = f.length; r--; )
                            u = f[r], !o && h !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(r, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
                        a && !f.length && (d.teardown && !1 !== d.teardown.call(e, g, m.handle) || ge.removeEvent(e, p, m.handle), delete l[p])
                    } else
                        for (p in l)
                            ge.event.remove(e, p + t[c], n, i, !0);
            ...
            if (s.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, s)) {
                for (a = ge.event.handlers.call(this, s, c), t = 0; (o = a[t++]) && !s.isPropagationStopped(); )
                    for (s.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !s.isImmediatePropagationStopped(); )
                        s.rnamespace && !1 !== r.namespace && !s.rnamespace.test(r.namespace) || (s.handleObj = r, s.data = r.data, void 0 !== (i = ((ge.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (s.result = i) && (s.preventDefault(), s.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && 1 <= e.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (r = [], a = {}, n = 0; n < l; n++)
                            void 0 === a[o = (i = t[n]).selector + " "] && (a[o] = i.needsContext ? -1 < ge(o, this).index(c) : ge.find(o, this, null, [c]).length), a[o] && r.push(i);
                        r.length && s.push({
                            elem: c,
                            handlers: r
                        })
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return Be.test(t.type) && t.click && r(t, "input") && S(t, "click", w),
                    !1
                },
                trigger: function (e) {
                    var t = this || e;
                    return Be.test(t.type) && t.click && r(t, "input") && S(t, "click"),
                    !0
                },
                _default: function (e) {
                    var t = e.target;
                    return Be.test(t.type) && t.click && r(t, "input") && Pe.get(t, "click") || r(t, "a")
                }
            },
            beforeunload: {
    ...
    ge.Event = function (e, t) {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? w : C, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e,
        t && ge.extend(this, t),
    ...
    ge.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(ce.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ge.isXMLDoc(e)))
                for (a = b(u), i = 0, o = (r = b(e)).length; i < o; i++)
                    s = r[i], l = a[i], "input" === (c = l.nodeName.toLowerCase()) && Be.test(s.type) ? l.checked = s.checked : "input" !== c && "textarea" !== c || (l.defaultValue = s.defaultValue);
            if (t)
                if (n)
                    for (r = r || b(e), a = a || b(u), i = 0, o = r.length; i < o; i++)
                        D(r[i], a[i]);
                else
                    D(e, u);
            return 0 < (a = b(u, "script")).length && y(a, !d && b(e, "script")),
            u
        },
            ...
            for (var t, n, i, o = ge.event.special, r = 0; void 0 !== (n = e[r]); r++)
                if (Oe(n)) {
                    if (t = n[Pe.expando]) {
                        if (t.events)
                            for (i in t.events)
                                o[i] ? ge.event.remove(n, i) : ge.removeEvent(n, i, t.handle);
                        n[Pe.expando] = void 0
                    }
        ...
        html: function (e) {
            return je(this, function (e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !nt.test(e) && !Ke[(_e.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = ge.htmlPrefilter(e);
                    try {
                        for (; n < i; n++)
                            1 === (t = this[n] || {}).nodeType && (ge.cleanData(b(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
    ...
    ge.each({
        ...
        ge.fn[e] = function (e) {
            for (var n, i = [], o = ge(e), r = o.length - 1, a = 0; a <= r; a++)
                n = a === r ? this : this.clone(!0), ge(o[a])[t](n), ne.apply(i, n.get());
    ...
    ge.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                l = ft.test(t),
                c = e.style;
                if (l || (t = q(s)), a = ge.cssHooks[t] || ge.cssHooks[s], void 0 === n)
                    return a && "get" in a && void 0 !== (o = a.get(e, !1, i)) ? o : c[t];
                "string" == (r = typeof n) && (o = Me.exec(n)) && o[1] && (n = m(e, t, o), r = "number"),
                null != n && n == n && ("number" !== r || l || (n += o && o[3] || (ge.cssNumber[s] ? "" : "px")), ce.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
    ...
    ge.each(["height", "width"], function (e, t) {
        ge.cssHooks[t] = {
            get: function (e, n, i) {
                if (n)
                    return !dt.test(ge.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? M(e, t, i) : Ve(e, pt, function () {
                        return M(e, t, i)
                    })
            },
            set: function (e, n, i) {
                ...
                l = i ? F(e, t, i, s, r) : 0;
                return s && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - F(e, t, "border", !1, r) - .5)),
                l && (o = Me.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = ge.css(e, t)),
                N(0, n, l)
            }
        }
    }),
    ...
    ge.fn.extend({
        css: function (e, t) {
            return je(this, function (e, t, n) {
                ...
                a = 0;
                if (Array.isArray(t)) {
                    for (i = at(e), o = t.length; a < o; a++)
                        r[t[a]] = ge.css(e, t[a], !1, i);
                    return r
                }
        ...
        prefilters: [function (e, t, n) {
                ...
                if ((l = !ge.isEmptyObject(t)) || !ge.isEmptyObject(p))
                    for (i in d && 1 === e.nodeType && (n.overflow = [g.overflow, g.overflowX, g.overflowY], null == (c = m && m.display) && (c = Pe.get(e, "display")), "none" === (u = ge.css(e, "display")) && (c ? u = c : (v([e], !0), c = e.style.display || c, u = ge.css(e, "display"), v([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === ge.css(e, "float") && (l || (f.done(function () {
                        ...
                        l || (m ? "hidden" in m && (h = m.hidden) : m = Pe.access(e, "fxshow", {
                                display: c
                            }), r && (m.hidden = !h), h && v([e], !0), f.done(function () {
                                for (i in h || v([e]), Pe.remove(e, "fxshow"), p)
                                    ge.style(e, i, p[i])
    ...
    ge.fn.extend({
        ...
        finish: function (e) {
            ...
            this.each(function () {
                ...
                r = ge.timers,
                a = i ? i.length : 0;
                for (n.finish = !0, ge.queue(this, e, []), o && o.stop && o.stop.call(this, !0), t = r.length; t--; )
    ...
    ge.fn.delay = function (t, n) {
        return t = ge.fx && ge.fx.speeds[t] || t,
        n = n || "fx",
    ...
    vt = Y.createElement("input"),
    bt = Y.createElement("select").appendChild(Y.createElement("option")),
    vt.type = "checkbox",
    ce.checkOn = "" !== vt.value,
    ce.optSelected = bt.selected,
    (vt = Y.createElement("input")).value = "t",
    vt.type = "radio",
    ...
    ge.extend({
        attr: function (e, t, n) {
            ...
            r = e.nodeType;
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === e.getAttribute ? ge.prop(e, t, n) : (1 === r && ge.isXMLDoc(e) || (o = ge.attrHooks[t.toLowerCase()] || (ge.expr.match.bool.test(t) ? wt : void 0)), void 0 !== n ? null === n ? void ge.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = ge.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    ge.each(ge.expr.match.bool.source.match(/\w+/g), function (e, t) {
        ...
        Ct[t] = function (e, t, i) {
            ...
            r,
            a = t.toLowerCase();
            return i || (r = Ct[a], Ct[a] = o, o = null != n(e, t, i) ? a : null, Ct[a] = r),
            o
        }
    });
    ...
    ge.extend({
        prop: function (e, t, n) {
            ...
            r = e.nodeType;
            if (3 !== r && 8 !== r && 2 !== r)
                return 1 === r && ge.isXMLDoc(e) || (t = ge.propFix[t] || t, o = ge.propHooks[t]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : e[t] = n : o && "get" in o && null !== (i = o.get(e, t)) ? i : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function (e) {
...
ge.fn.extend({
    addClass: function (e) {
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : ue(e) ? this.each(function (n) {
                ...
                a;
                if (i)
                    for (o = 0, r = ge(this), a = _(e); t = a[o++]; )
                        r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                else
                    void 0 !== e && "boolean" !== n || ((t = B(this)) && Pe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Pe.get(this, "__className__") || ""))
            })
        },
        hasClass: function (e) {
            var t,
    ...
    ge.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function (e, t) {
                    for (var n, i, o = e.options, r = ge.makeArray(t), a = o.length; a--; )
                        ((i = o[a]).selected = -1 < ge.inArray(ge.valHooks.option.get(i), r)) && (n = !0);
        ...
        trigger: function (t, n, i, o) {
            ...
            if (a = f = s = i = i || Y, 3 !== i.nodeType && 8 !== i.nodeType && !At.test(g + ge.event.triggered) && (-1 < g.indexOf(".") && (g = (h = g.split(".")).shift(), h.sort()), c = g.indexOf(":") < 0 && "on" + g, (t = t[ge.expando] ? t : new ge.Event(g, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : ge.makeArray(n, [t]), d = ge.event.special[g] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!o && !d.noBubble && !de(i)) {
                    for (l = d.delegateType || g, At.test(l + g) || (a = a.parentNode); a; a = a.parentNode)
                        p.push(a), s = a;
                    s === (i.ownerDocument || Y) && p.push(s.defaultView || s.parentWindow || e)
                }
                for (r = 0; (a = p[r++]) && !t.isPropagationStopped(); )
                    f = a, t.type = 1 < r ? l : d.bindType || g, (u = (Pe.get(a, "events") || {})[t.type] && Pe.get(a, "handle")) && u.apply(a, n), (u = c && a[c]) && u.apply && Oe(a) && (t.result = u.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = g,
                o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(p.pop(), n) || !Oe(i) || c && ue(i[g]) && !de(i) && ((s = i[c]) && (i[c] = null), ge.event.triggered = g, t.isPropagationStopped() && f.addEventListener(g, Et), i[g](), t.isPropagationStopped() && f.removeEventListener(g, Et), ge.event.triggered = void 0, s && (i[c] = s)),
                t.result
            }
        },
    ...
    ge.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !ge(this).is(":disabled") && qt.test(this.nodeName) && !Lt.test(e) && (this.checked || !Be.test(e))
            }).map(function (e, t) {
                var n = ge(this).val();
        ...
        ajax: function (t, n) {
            ...
            if (v.promise(k), g.url = ((t || g.url || jt.href) + "").replace($t, jt.protocol + "//"), g.type = n.method || n.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(Se) || [""], null == g.crossDomain) {
                ...
                try {
                    c.href = g.url,
                    c.href = c.href,
                    g.crossDomain = Wt.protocol + "//" + Wt.host != c.protocol + "//" + c.host
                } catch (t) {
                    g.crossDomain = !0
                }
            }
            if (g.data && g.processData && "string" != typeof g.data && (g.data = ge.param(g.data, g.traditional)), Q(zt, g, n, k), u)
                return k;
            for (f in(d = ge.event && g.global) && 0 == ge.active++ && ge.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Ht.test(g.type), r = g.url.replace(Ft, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Nt, "+")) : (p = g.url.slice(r.length), g.data && (g.processData || "string" == typeof g.data) && (r += (Rt.test(r) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (r = r.replace(Mt, "$1"), p = (Rt.test(r) ? "&" : "?") + "_=" + Dt++ + p), g.url = r + p), g.ifModified && (ge.lastModified[r] && k.setRequestHeader("If-Modified-Since", ge.lastModified[r]), ge.etag[r] && k.setRequestHeader("If-None-Match", ge.etag[r])), (g.data && g.hasContent && !1 !== g.contentType || n.contentType) && k.setRequestHeader("Content-Type", g.contentType), k.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Vt + "; q=0.01" : "") : g.accepts["*"]), g.headers)
                k.setRequestHeader(f, g.headers[f]);
            if (g.beforeSend && (!1 === g.beforeSend.call(h, k, g) || u))
                return k.abort();
            if (C = "abort", b.add(g.complete), k.done(g.success), k.fail(g.error), o = Q(Ut, g, n, k)) {
                if (k.readyState = 1, d && m.trigger("ajaxSend", [k, g]), u)
                    return k;
    ...
    ge.each(["get", "post"], function (e, t) {
        ge[t] = function (e, n, i, o) {
            return ue(n) && (o = o || i, i = n, n = void 0),
            ge.ajax(ge.extend({
                    url: e,
                    type: t,
                    dataType: o,
        ...
        if (ce.cors || _t && !t.crossDomain)
            return {
                send: function (o, r) {
                    ...
                    n = function (e) {
                        return function () {
                            n && (n = i = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(Bt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                    binary: s.response
                                }
                                     : {
                                    text: s.responseText
    ...
    ge.ajaxPrefilter("json jsonp", function (t, n, i) {
        ...
        if (s || "jsonp" === t.dataTypes[0])
            return o = t.jsonpCallback = ue(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Qt, "$1" + o) : !1 !== t.jsonp && (t.url += (Rt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
    ...
    ce.createHTMLDocument = ((Xt = Y.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Xt.childNodes.length),
    ...
    ge.fn.load = function (e, t, n) {
        ...
        a = this,
        s = e.indexOf(" ");
        return -1 < s && (i = W(e.slice(s)), e = e.slice(0, s)),
        ue(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"),
        0 < a.length && ge.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
    ...
    ge.fn.extend({
        ...
        position: function () {
            if (this[0]) {
                ...
                if ("fixed" === ge.css(i, "position"))
                    t = i.getBoundingClientRect();
                else {
                    for (t = this.offset(), n = i.ownerDocument, e = i.offsetParent || n.documentElement; e && (e === n.body || e === n.documentElement) && "static" === ge.css(e, "position"); )
                        e = e.parentNode;
    ...
    ge.each({
        ...
        ge.fn[e] = function (i) {
            return je(this, function (e, i, o) {
                var r;
                if (de(e) ? r = e : 9 === e.nodeType && (r = e.defaultView), void 0 === o)
                    return r ? r[t] : e[i];
    ...
    ge.each(["top", "left"], function (e, t) {
        ge.cssHooks[t] = L(ce.pixelPosition, function (e, n) {
            if (n)
                return n = P(e, t), rt.test(n) ? ge(e).position()[t] + "px" : n
        })
    }),
    ge.each({
        Height: "height",
    ...
    ge.proxy = function (e, t) {
        ...
        if ("string" == typeof t && (n = e[t], t = e, e = n), ue(e))
            return i = ee.call(arguments, 2), (o = function () {
...
(function (e) {
    function t() {
        ...
        var a = n(this);
        return isNaN(a.datetime) || (0 === t.cutoff || Math.abs(o(a.datetime)) < t.cutoff ? e(this).text(i(a.datetime)) : e(this).attr("title").length > 0 && e(this).text(e(this).attr("title"))),
        this
    }
    function n(t) {
    ...
    e.extend(e.timeago, {
        ...
        inWords: function (t) {
            ...
            o = i.prefixAgo,
            r = i.suffixAgo;
            if (this.settings.allowFuture && t < 0 && (o = i.prefixFromNow, r = i.suffixFromNow), !this.settings.allowPast && t >= 0)
            ...
            f = i.wordSeparator || "";
            return void 0 === i.wordSeparator && (f = " "),
            e.trim([o, d, r].join(f))
        },
        parse: function (t) {
            var n = e.trim(t);
    ...
    var a = {
        ...
        update: function (n) {
            ...
            r.settings.localeTitle && e(this).attr("title", i.toLocaleString()),
            t.apply(this)
        },
...
function (e, t, n, i) {
    e.site = e.fn.site = function (o) {
        ...
        return r = {
            ...
            fix: {
                console: function () {
                    ...
                    void 0 !== console.group && void 0 !== console.groupEnd && void 0 !== console.groupCollapsed || (r.verbose("Console group not available, normalizing events"), t.console.group = function () {}, t.console.groupEnd = function () {}, t.console.groupCollapsed = function () {}),
                    void 0 === console.markTimeline && (r.verbose("Mark timeline not available, normalizing events"), t.console.markTimeline = function () {})
                },
            ...
            console: function (e) {
                if (e) {
                    if (y.cache.console === i)
                        return void r.error(g.console);
                    r.debug("Restoring console function"),
                    t.console = y.cache.console
                } else
                    r.debug("Disabling console function"), y.cache.console = t.console, t.console = {
                        clear: function () {},
                        error: function () {},
                        group: function () {},
            ...
            invoke: function (t, n, o) {
                ...
                return n = n || d,
                o = b || o,
                "string" == typeof t && u !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (n, o) {
                        ...
                        if (e.isPlainObject(u[a]) && n != s)
                            ...
                            if (!e.isPlainObject(u[o]) || n == s)
                                return u[o] !== i ? (l = u[o], !1) : (r.error(g.method, t), !1);
                            u = u[o]
                        }
                    })),
        ...
        u ? (y === i && r.initialize(), r.invoke(c)) : (y !== i && r.destroy(), r.initialize()),
        a !== i ? a : this
    },
    e.site.settings = {
        name: "Site",
    ...
    e.fn.form = function (t) {
        ...
        return r.each(function () {
            ...
            R = {
                initialize: function () {
                    R.get.settings(),
                    d ? (D === i && R.instantiate(), R.invoke(c)) : (D !== i && D.invoke("destroy"), R.verbose("Initializing form validation", O, x), R.bindEvents(), R.set.defaults(), R.instantiate())
                },
                instantiate: function () {
                ...
                destroy: function () {
                    R.verbose("Destroying previous module", D),
                    R.removeEvents(),
                    O.removeData(E)
                },
                refresh: function () {
                ...
                bindEvents: function () {
                    ...
                    O.on("submit" + j, R.validate.form).on("blur" + j, k.field, R.event.field.blur).on("click" + j, k.submit, R.submit).on("click" + j, k.reset, R.reset).on("click" + j, k.clear, R.clear),
                    x.keyboardShortcuts && O.on("keydown" + j, k.field, R.event.field.keydown),
                    p.each(function () {
                        var t = e(this),
                        n = t.prop("type"),
                ...
                clear: function () {
                    p.each(function () {
                        ...
                        a = n.is(k.uiCheckbox),
                        s = n.is(k.uiDropdown);
                        i.hasClass(T.error) && (R.verbose("Resetting error on field", i), i.removeClass(T.error), o.remove()),
                        s ? (R.verbose("Resetting dropdown value", n, r), n.dropdown("clear")) : a ? t.prop("checked", !1) : (R.verbose("Resetting field value", t, r), t.val(""))
                    })
                },
                reset: function () {
                    p.each(function () {
                ...
                is: {
                    ...
                    valid: function () {
                        var t = !0;
                        return R.verbose("Checking if form is valid"),
                ...
                event: {
                    field: {
                        keydown: function (t) {
                            ...
                            i == s.escape && (R.verbose("Escape key pressed blurring field"), n.blur()),
                            t.ctrlKey || i != s.enter || !o || a || r || (q || (n.one("keyup" + j, R.event.field.keyup), R.submit(), R.debug("Enter pressed on input submitting form")), q = !0)
                        },
                        keyup: function () {
                            q = !1
                        },
                        ...
                        change: function (t) {
                            ...
                            ("change" == x.on || i.hasClass(T.error) && x.revalidate) && (clearTimeout(R.timer), R.timer = setTimeout(function () {
                                    R.debug("Revalidating field", n, R.get.validation(n)),
                                    R.validate.field(o)
                                }, x.delay))
                        }
                    }
                ...
                get: {
                    ...
                    prompt: function (e, t) {
                        ...
                        l = -1 !== s.search("{value}"),
                        c = -1 !== s.search("{name}");
                        return (c || l) && (i = R.get.field(t.identifier)),
                        ...
                        e.prompt || R.verbose("Using default validation prompt for type", s, r),
                        s
                    },
                    settings: function () {
                        if (e.isPlainObject(t)) {
                            ...
                            x = e.fn.form.settings, w = e.fn.form.settings.defaults, R.verbose("Using default form validation", w, x);
                        A = x.namespace,
                        C = x.metadata,
                        k = x.selector,
                        T = x.className,
                    ...
                    field: function (t) {
                        return R.verbose("Finding field with identifier", t),
                        p.filter("#" + t).length > 0 ? p.filter("#" + t) : p.filter('[name="' + t + '"]').length > 0 ? p.filter('[name="' + t + '"]') : p.filter('[name="' + t + '[]"]').length > 0 ? p.filter('[name="' + t + '[]"]') : p.filter("[data-" + C.validate + '="' + t + '"]').length > 0 ? p.filter("[data-" + C.validate + '="' + t + '"]') : e("<input/>")
                    },
                    fields: function (t) {
                        var n = e();
                    ...
                    validation: function (t) {
                        ...
                        return !!w && (e.each(w, function (e, o) {
                                i = o.identifier || e,
                                R.get.field(i)[0] == t[0] && (o.identifier = i, n = o)
                            }), n || !1)
                    },
                    value: function (e) {
                        var t,
                ...
                has: {
                    field: function (e) {
                        return R.verbose("Checking for existence of a field with identifier", e),
                        "string" != typeof e && R.error(S.identifier, e),
                        p.filter("#" + e).length > 0 || p.filter('[name="' + e + '"]').length > 0 || p.filter("[data-" + C.validate + '="' + e + '"]').length > 0
                    }
                },
                add: {
                    prompt: function (t, n) {
                ...
                remove: {
                    prompt: function (t) {
                        ...
                        x.inline && r.is(":visible") && (R.verbose("Removing prompt for field", t), x.transition && e.fn.transition !== i && O.transition("is supported") ? r.transition(x.transition + " out", x.duration, function () {
                                r.remove()
                ...
                validate: {
                    form: function (e, t) {
                        ...
                        if (q)
                            return !1;
                        if (L = [], R.is.valid()) {
                            if (R.debug("Form has no validation errors, submitting"), R.set.success(), !0 !== t)
                                return x.onSuccess.call(P, e, n)
                        } else if (R.debug("Form has errors"), R.set.error(), x.inline || R.add.errors(L), O.data("moduleApi") !== i && e.stopImmediatePropagation(), !0 !== t)
                            return x.onFailure.call(P, L, n)
                    },
                    field: function (t, n) {
                        ...
                        s = !0,
                        l = [];
                        return t.identifier || (R.debug("Using field name as identifier", o), t.identifier = o),
                        r.prop("disabled") ? (R.debug("Field is disabled. Skipping", o), s = !0) : t.optional && R.is.blank(r) ? (R.debug("Field is optional and blank. Skipping", o), s = !0) : t.depends && R.is.empty(a) ? (R.debug("Field depends on another value that is not present or empty. Skipping", a), s = !0) : t.rules !== i && e.each(t.rules, function (e, n) {
                ...
                invoke: function (t, n, r) {
                    ...
                    return n = n || f,
                    r = P || r,
                    "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function (n, o) {
    ...
    e.fn.form.settings = {
        ...
        rules: {
            ...
            integer: function (t, n) {
                ...
                return n && -1 === ["", ".."].indexOf(n) && (-1 == n.indexOf("..") ? s.test(n) && (o = r = n - 0) : (a = n.split("..", 2), s.test(a[0]) && (o = a[0] - 0), s.test(a[1]) && (r = a[1] - 0))),
                s.test(t) && (o === i || t >= o) && (r === i || t <= r)
            },
            decimal: function (t) {
            ...
            match: function (t, n) {
                var o;
                return e(this),
                e('[data-validate="' + n + '"]').length > 0 ? o = e('[data-validate="' + n + '"]').val() : e("#" + n).length > 0 ? o = e("#" + n).val() : e('[name="' + n + '"]').length > 0 ? o = e('[name="' + n + '"]').val() : e('[name="' + n + '[]"]').length > 0 && (o = e('[name="' + n + '[]"]')),
            ...
            f = {
                ...
                bind: {
                    events: function () {
                        ...
                        w.on(p.on + b, m.trigger, f.event.click)
                    }
                },
                event: {
                    click: function () {
                ...
                closeOthers: function (t) {
                    ...
                    o,
                    r,
                    a = t !== i ? C.eq(t) : e(this).closest(m.title),
                    ...
                    n.length > 0 && (f.debug("Exclusive enabled, closing other content", n), n.removeClass(g.active), r.removeClass(g.animating).stop(!0, !0), p.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? r.children().transition({
                                animation: "fade out",
                                useFailSafe: !0,
                                debug: p.debug,
                                verbose: p.verbose,
...
(jQuery, window, document), function (e, t, n, i) {
    ...
    e.fn.checkbox = function (o) {
        ...
        return a.each(function () {
            ...
            p = {
                initialize: function () {
                    p.verbose("Initializing checkbox", g),
                    p.create.label(),
                    p.bind.events(),
                    p.set.tabbable(),
                    p.hide.input(),
                ...
                set: {
                    ...
                    checked: function () {
                        ...
                        w.removeClass(h.indeterminate).addClass(h.checked),
                        p.is.radio() && p.uncheckOthers(),
                        !p.is.indeterminate() && p.is.checked() ? void p.debug("Input is already checked, skipping input property change") : (p.verbose("Setting state to checked", T), k.prop("indeterminate", !1).prop("checked", !0), void p.trigger.change())
                    },
                    unchecked: function () {
                        return p.verbose("Removing checked class"),
                        w.removeClass(h.indeterminate).removeClass(h.checked),
                        !p.is.indeterminate() && p.is.unchecked() ? void p.debug("Input is already unchecked") : (p.debug("Setting state to unchecked"), k.prop("indeterminate", !1).prop("checked", !1), void p.trigger.change())
                    },
                    indeterminate: function () {
                        return p.verbose("Setting class to indeterminate"),
                        w.addClass(h.indeterminate),
                        p.is.indeterminate() ? void p.debug("Input is already indeterminate, skipping input property change") : (p.debug("Setting state to indeterminate"), k.prop("indeterminate", !0), void p.trigger.change())
                    },
                    determinate: function () {
                        return p.verbose("Removing indeterminate class"),
                        w.removeClass(h.indeterminate),
                        p.is.determinate() ? void p.debug("Input is already determinate, skipping input property change") : (p.debug("Setting state to determinate"), void k.prop("indeterminate", !1))
                    },
                    disabled: function () {
                        return p.verbose("Setting class to disabled"),
                        w.addClass(h.disabled),
                        p.is.disabled() ? void p.debug("Input is already disabled, skipping input property change") : (p.debug("Setting state to disabled"), k.prop("disabled", "disabled"), void p.trigger.change())
                    },
                    enabled: function () {
                        return p.verbose("Removing disabled class"),
                        w.removeClass(h.disabled),
                        p.is.enabled() ? void p.debug("Input is already enabled, skipping input property change") : (p.debug("Setting state to enabled"), k.prop("disabled", !1), void p.trigger.change())
                    },
                    tabbable: function () {
    ...
    e.fn.dimmer = function (t) {
        ...
        return r.each(function () {
            ...
            p = {
                ...
                bind: {
                    events: function () {
                        "hover" == g.on ? f.on("mouseenter" + y, p.show).on("mouseleave" + y, p.hide) : "click" == g.on && f.on(C + y, p.toggle),
                ...
                create: function () {
                    ...
                    return g.dimmerName && (p.debug("Creating named dimmer", g.dimmerName), t.addClass(g.dimmerName)),
                    t.appendTo(f),
                    t
                },
                show: function (t) {
                    t = e.isFunction(t) ? t : function () {},
                    p.debug("Showing dimmer", d, g),
                    p.is.dimmed() && !p.is.animating() || !p.is.enabled() ? p.debug("Dimmer is already shown or disabled") : (p.animate.show(t), g.onShow.call(T), g.onChange.call(T))
                },
                hide: function (t) {
                    t = e.isFunction(t) ? t : function () {},
                    p.is.dimmed() || p.is.animating() ? (p.debug("Hiding dimmer", d), p.animate.hide(t), g.onHide.call(T), g.onChange.call(T)) : p.debug("Dimmer is not visible")
                },
                toggle: function () {
                ...
                animate: {
                    show: function (t) {
                        t = e.isFunction(t) ? t : function () {},
                        g.useCSS && e.fn.transition !== i && d.transition("is supported") ? ("auto" !== g.opacity && p.set.opacity(), d.transition({
                    ...
                    hide: function (t) {
                        t = e.isFunction(t) ? t : function () {},
                        g.useCSS && e.fn.transition !== i && d.transition("is supported") ? (p.verbose("Hiding dimmer with css"), d.transition({
            ...
            k = {
                ...
                select: {
                    firstUnfiltered: function () {
                        ...
                        _.not(P.unselectable).not(P.addition + P.hidden).eq(0).addClass(S.selected)
                    },
                ...
                setup: {
                    ...
                    layout: function () {
                        M.is("select") && (k.setup.select(), k.setup.returnedObject()),
                        k.has.menu() || k.create.menu(),
                        k.is.search() && !k.has.search() && (k.verbose("Adding search input"), $ = e("<input />").addClass(S.search).prop("autocomplete", "off").insertBefore(H)),
                    ...
                    select: function () {
                        ...
                        M.is("select") && (U = M),
                        U.parent(P.dropdown).length > 0 ? (k.debug("UI dropdown already exists. Creating dropdown menu only"), M = U.closest(P.dropdown), k.has.menu() || k.create.menu(), B = M.children(P.menu), k.setup.menu(t)) : (k.debug("Creating entire dropdown from select"), M = e("<div />").attr("class", U.attr("class")).addClass(S.selection).addClass(S.dropdown).html(q.dropdown(t)).insertBefore(U), U.hasClass(S.multiple) && !1 === U.prop("multiple") && (k.error(L.missingMultiple), U.prop("multiple", !0)), U.is("[multiple]") && k.set.multiple(), U.prop("disabled") && (k.debug("Disabling dropdown"), M.addClass(S.disabled)), U.removeAttr("class").detach().prependTo(M)),
                        k.refresh()
                    },
                    menu: function (e) {
                        B.html(q.menu(e, E)),
                ...
                refreshData: function () {
                    ...
                    _.removeData(D.text).removeData(D.value)
                },
                clearData: function () {
                    k.verbose("Clearing metadata"),
                    _.removeData(D.text).removeData(D.value),
                    M.removeData(D.defaultText).removeData(D.defaultValue).removeData(D.placeholderText)
                },
                toggle: function () {
                ...
                hide: function (t) {
                    t = e.isFunction(t) ? t : function () {},
                    k.is.active() && (k.debug("Hiding dropdown"), !1 !== T.onHide.call(J) && k.animate.hide(function () {
                            k.remove.visible(),
                            t.call(J)
                        }))
                },
                hideOthers: function () {
                    ...
                    a.not(M).has(P.menu + "." + S.visible).dropdown("hide")
                },
                hideMenu: function () {
                ...
                filterItems: function (t) {
                    ...
                    r = k.escape.regExp(n),
                    a = new RegExp("^" + r, "igm");
                    k.has.query() && (o = [], k.verbose("Searching for matching values", n), _.each(function () {
                            var t,
                            i,
                            r = e(this);
                            if ("both" == T.match || "text" == T.match) {
                                if (t = String(k.get.choiceText(r, !1)), -1 !== t.search(a))
                                    return o.push(this), !0;
                                if ("exact" === T.fullTextSearch && k.exactSearch(n, t))
                                    return o.push(this), !0;
                                if (!0 === T.fullTextSearch && k.fuzzySearch(n, t))
                                    return o.push(this), !0
                            }
                            if ("both" == T.match || "value" == T.match) {
                                if (i = String(k.get.choiceValue(r, t)), -1 !== i.search(a))
                                    return o.push(this), !0;
                ...
                filterActive: function () {
                    T.useLabels && _.filter("." + S.active).addClass(S.filtered)
                },
                ...
                forceSelection: function () {
                    var e = _.not(S.filtered).filter("." + S.selected).eq(0),
                    t = _.not(S.filtered).filter("." + S.active).eq(0),
                    n = e.length > 0 ? e : t;
                ...
                event: {
                    ...
                    blur: function (e) {
                        ...
                        X || v || (k.remove.activeLabel(), k.hide())
                    },
                    mousedown: function () {
                    ...
                    search: {
                        ...
                        blur: function (e) {
                            v = n.activeElement === this,
                            b || K || v || (T.forceSelection && k.forceSelection(), k.hide()),
                            b = !1
                        }
                    },
                    icon: {
                    ...
                    keydown: function (e) {
                        ...
                        if (k.is.inObject(t, j)) {
                            var n,
                            i = _.not(P.unselectable).filter("." + S.selected).eq(0),
                            o = B.children("." + S.active).eq(0),
                            r = i.length > 0 ? i : o,
                            a = r.length > 0 ? r.siblings(":not(." + S.filtered + ")").addBack() : B.children(":not(." + S.filtered + ")"),
                            s = r.children(P.menu),
                            l = r.closest(P.menu),
                            ...
                            if (T.allowAdditions && T.hideAdditions && (t == j.enter || p) && f && (k.verbose("Selecting item from keyboard shortcut", r), k.event.item.click.call(r, e), k.is.searchSelection() && k.remove.searchTerm()), k.is.visible()) {
                                if ((t == j.enter || p) && (t == j.enter && d && u && !T.allowCategorySelection ? (k.verbose("Pressed enter on unselectable category, opening sub menu"), t = j.rightArrow) : f && (k.verbose("Selecting item from keyboard shortcut", r), k.event.item.click.call(r, e), k.is.searchSelection() && k.remove.searchTerm()), e.preventDefault()), d && (t == j.leftArrow && l[0] !== B[0] && (k.verbose("Left key pressed, closing sub-menu"), k.animate.hide(!1, l), r.removeClass(S.selected), l.closest(P.item).addClass(S.selected), e.preventDefault()), t == j.rightArrow && u && (k.verbose("Right key pressed, opening sub-menu"), k.animate.show(!1, s), r.removeClass(S.selected), s.find(P.item).eq(0).addClass(S.selected), e.preventDefault())), t == j.upArrow) {
                                    if (n = d && c ? r.prevAll(P.item + ":not(" + P.unselectable + ")").eq(0) : _.eq(0), a.index(n) < 0)
                                    ...
                                    k.set.scrollPosition(n),
                                    T.selectOnKeydown && k.is.single() && k.set.selectedItem(n),
                                    e.preventDefault()
                                }
                                if (t == j.downArrow) {
                                    if (n = d && c ? n = r.nextAll(P.item + ":not(" + P.unselectable + ")").eq(0) : _.eq(0), 0 === n.length)
                                ...
                                t == j.pageUp && (k.scrollPage("up"), e.preventDefault()),
                                t == j.pageDown && (k.scrollPage("down"), e.preventDefault()),
                                t == j.escape && (k.verbose("Escape key pressed, closing dropdown"), k.hide())
                            } else
                                p && e.preventDefault(), t != j.downArrow || k.is.visible() || (k.verbose("Down key pressed, showing dropdown"), k.select.firstUnfiltered(), k.show(), e.preventDefault())
                        } else
                ...
                determine: {
                    selectAction: function (t, n) {
                        ...
                        e.isFunction(k.action[T.action]) ? (k.verbose("Triggering preset action", T.action, t, n), k.action[T.action].call(J, t, n, this)) : e.isFunction(T.action) ? (k.verbose("Triggering user action", T.action, t, n), T.action.call(J, t, n, this)) : k.error(L.action, T.action)
                    },
                    eventInModule: function (t, i) {
                        ...
                        r && !a ? (k.verbose("Triggering event", i), i(), !0) : (k.verbose("Event occurred in dropdown, canceling callback"), !1)
                    },
                    eventOnElement: function (t, i) {
                        ...
                        return i = e.isFunction(i) ? i : function () {},
                        a && s && l ? (k.verbose("Triggering event", i), i(), !0) : (k.verbose("Event occurred in dropdown menu, canceling callback"), !1)
                    }
                },
                action: {
                    nothing: function () {},
                ...
                get: {
                    ...
                    choiceText: function (t, n) {
                        if (n = n !== i ? n : T.preserveHTML, t)
                            return t.find(P.menu).length > 0 && (k.verbose("Retrieving text of element with sub-menu"), t = t.clone(), t.find(P.menu).remove(), t.find(P.menuIcon).remove()), t.data(D.text) !== i ? t.data(D.text) : n ? e.trim(t.html()) : e.trim(t.text())
                    },
                    ...
                    selectValues: function () {
                        ...
                        T.placeholder && "auto" !== T.placeholder && (k.debug("Setting placeholder value to", T.placeholder), t.placeholder = T.placeholder),
                        T.sortSelect ? (t.values.sort(function (e, t) {
                    ...
                    selectedItem: function () {
                        var e = _.not(P.unselectable).filter("." + S.selected);
                    ...
                    item: function (t, n) {
                        ...
                        o && _.each(function () {
                            ...
                            if (null !== l && l !== i)
                                if (r)
                                     - 1 === e.inArray(String(l), t) && -1 === e.inArray(s, t) || (a = a ? a.add(o) : o);
                                else if (n) {
                ...
                check: {
                    maxSelections: function (e) {
                        return !T.maxSelections || (e = e !== i ? e : k.get.selectionCount(), e >= T.maxSelections ? (k.debug("Maximum selection count reached"), T.useLabels && (_.addClass(S.filtered), k.add.message(A.maxSelections)), !0) : (k.verbose("No longer at maximum selection count"), k.remove.message(), k.remove.filteredItem(), k.is.searchSelection() && k.filterItems(), !1))
                    }
                },
                restore: {
                    defaults: function () {
                    ...
                    labels: function () {
                        T.allowAdditions && (T.useLabels || (k.error(L.labels), T.useLabels = !0), k.debug("Restoring selected values"), k.create.userLabels()),
                ...
                save: {
                    ...
                    defaultValue: function () {
                        ...
                        M.data(D.defaultValue, e)
                    },
                    defaultText: function () {
                        var e = k.get.text();
                        k.verbose("Saving default text as", e),
                        M.data(D.defaultText, e)
                    },
                    placeholderText: function () {
                        var e;
                ...
                set: {
                    filtered: function () {
                        ...
                        r = k.get.searchWidth(),
                        a = "" !== i;
                        e && o && (k.verbose("Adjusting input width", r, T.glyphWidth), $.css("width", r)),
                        o || n && a ? (k.verbose("Hiding placeholder text"), H.addClass(S.filtered)) : (!e || n && !a) && (k.verbose("Showing placeholder text"), H.removeClass(S.filtered))
                    },
                    empty: function () {
                        M.addClass(S.empty)
                    },
                    ...
                    placeholderText: function (e) {
                        ...
                        k.set.text(e),
                        H.addClass(S.placeholder)
                    },
                    tabbable: function () {
                        k.has.search() ? (k.debug("Added tabindex to searchable dropdown"), $.val("").attr("tabindex", 0), B.attr("tabindex", -1)) : (k.debug("Added tabindex to dropdown"), M.attr("tabindex") === i && (M.attr("tabindex", 0), B.attr("tabindex", -1)))
                    },
                    initialLoad: function () {
                    ...
                    scrollPosition: function (e, t) {
                        ...
                        o = e && e.length > 0,
                        t = t !== i && t,
                        e && n.length > 0 && o && (a = e.position().top, n.addClass(S.loading), l = n.scrollTop(), s = n.offset().top, a = e.offset().top, r = l - s + a, t || (c = n.height(), d = l + c < r + 5, u = r - 5 < l), k.debug("Scrolling to active item", r), (t || u || d) && n.scrollTop(r), n.removeClass(S.loading))
                    },
                    text: function (e) {
                    ...
                    selectedLetter: function (t) {
                        ...
                        r = !1;
                        o && (n = i.nextAll(_).eq(0), k.has.firstLetter(n, t) && (r = n)),
                        r || _.each(function () {
                    ...
                    value: function (e, t, n) {
                        ...
                        if (r) {
                            ...
                            Q = !0,
                            U.val(o),
                            !1 === T.fireOnInit && k.is.initialLoad() ? k.debug("Input native change event ignored on initial load") : k.trigger.change(),
                            Q = !1
                        } else
                            k.verbose("Storing value in metadata", o, U), o !== a && M.data(D.value, s);
                ...
                add: {
                    label: function (t, n, i) {
                        var o,
                        r = k.is.searchSelection() ? $ : H,
                        a = k.escape.value(t);
                        return o = e("<a />").addClass(S.label).attr("data-value", a).html(q.label(a, n)),
                        o = T.onLabelCreate.call(o, a, n),
                        k.has.label(t) ? void k.debug("Label already exists, skipping", a) : (T.label.variation && o.addClass(T.label.variation), void(!0 === i ? (k.debug("Animating in label", o), o.addClass(S.hidden).insertBefore(r).transition(T.label.transition, T.label.duration)) : (k.debug("Adding selection label", o), o.insertBefore(r))))
                    },
                    message: function (t) {
                        var n = B.children(P.message),
                    ...
                    userSuggestion: function (e) {
                        ...
                        if (!T.useLabels || !k.has.maxSelections()) {
                            ...
                            r ? (n.data(D.value, e).data(D.text, e).attr("data-" + D.value, e).attr("data-" + D.text, e).removeClass(S.filtered), T.hideAdditions || (t = T.templates.addition(k.add.variables(A.addResult, e)), n.html(t)), k.verbose("Replacing user suggestion with new value", n)) : (n = k.create.userChoice(e), n.prependTo(B), k.verbose("Adding item choice to menu corresponding with user choice addition", n)),
                    ...
                    variables: function (e, t) {
                        ...
                        r && (n = k.get.selectionCount(), e = e.replace("{maxCount}", T.maxSelections)),
                        a && (i = t || k.get.query(), e = e.replace("{term}", i)),
                        e
                    },
                ...
                remove: {
                    ...
                    filteredItem: function () {
                        T.useLabels && k.has.maxSelections() || (T.useLabels && k.is.multiple() ? _.not("." + S.active).removeClass(S.filtered) : _.removeClass(S.filtered), k.remove.empty())
                    },
                    ...
                    value: function (e, t, n) {
                        ...
                        !1 === T.fireOnInit && k.is.initialLoad() ? k.verbose("No callback on initial load", T.onRemove) : T.onRemove.call(J, e, t, n),
                        k.set.value(i, t, n),
                        k.check.maxSelections()
                    },
                    ...
                    activeLabels: function (e) {
                        e = e || M.find(P.label).filter("." + S.active),
                    ...
                    tabbable: function () {
                        k.has.search() ? (k.debug("Searchable dropdown initialized"), $.removeAttr("tabindex"), B.removeAttr("tabindex")) : (k.debug("Simple selection dropdown initialized"), M.removeAttr("tabindex"), B.removeAttr("tabindex"))
                    }
                },
                has: {
                    menuSearch: function () {
                        return k.has.search() && $.closest(B).length > 0
                    },
                    search: function () {
                        return $.length > 0
                    },
                ...
                animate: {
                    show: function (t, n) {
                        ...
                        (k.is.hidden(r) || k.is.animating(r)) && ("none" == o ? (a(), r.transition("show"), t.call(J)) : e.fn.transition !== i && M.transition("is supported") ? r.transition({
                                animation: o + " in",
                                debug: T.debug,
                                verbose: T.verbose,
                                duration: T.duration,
                    ...
                    hide: function (t, n) {
                        var o = n || B,
                        r = (n ? T.duration : T.duration, n ? function () {}
                             : function () {
                        ...
                        t = e.isFunction(t) ? t : function () {},
                        (k.is.visible(o) || k.is.animating(o)) && (k.verbose("Doing menu hide animation", o), "none" == a ? (r(), o.transition("hide"), t.call(J)) : e.fn.transition !== i && M.transition("is supported") ? o.transition({
                                animation: a + " out",
                                duration: T.duration,
                                debug: T.debug,
                                verbose: T.verbose,
                    ...
                    "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function (n, o) {
                            ...
                            if (e.isPlainObject(c[r]) && n != a)
                                ...
                                if (c[r] !== i)
                                    return s = c[r], !1;
                                if (!e.isPlainObject(c[o]) || n == a)
                                    return c[o] !== i ? (s = c[o], !1) : (k.error(L.method, t), !1);
                                c = c[o]
                            }
                        })),
                    e.isFunction(s) ? l = s.apply(o, n) : s !== i && (l = s),
            ...
            f = {
                ...
                determine: {
                    ...
                    url: function () {
                        ...
                        return e = m[n] !== i && m[n].url.replace("{id}", t),
                        e && k.data(b.url, e),
                        e
                    }
                },
...
(jQuery, window, document), function (e, t, n, i) {
    ...
    e.fn.modal = function (o) {
        ...
        return a.each(function () {
            ...
            T = {
                initialize: function () {
                    T.verbose("Initializing dimmer", L),
                    T.create.id(),
                    T.create.dimmer(),
                    T.refreshModals(),
                    T.bind.events(),
                ...
                create: {
                    dimmer: function () {
                        ...
                        return S.inverted && (n.variation = n.variation !== i ? n.variation + " inverted" : "inverted"),
                        e.fn.dimmer === i ? void T.error(D.dimmer) : (T.debug("Creating dimmer with settings", n), y = L.dimmer(n), S.detachable ? (T.verbose("Modal is detachable, moving content into dimmer"), y.dimmer("add content", P)) : T.set.undetached(), S.blurring && y.addClass(E.blurring), void(x = y.dimmer("get dimmer")))
                    },
                    id: function () {
                ...
                refreshModals: function () {
                    v = P.siblings(A.modal),
                    a = v.add(P)
                },
                attachEvents: function (t, n) {
                    var i = e(t);
                    n = e.isFunction(T[n]) ? T[n] : T.toggle,
                    i.length > 0 ? (T.debug("Attaching modal events to element", t, n), i.off(R).on("click" + R, n)) : T.error(D.notFound, t)
                },
                bind: {
                    events: function () {
                        T.verbose("Attaching events"),
                        P.on("click" + R, A.close, T.event.close).on("click" + R, A.approve, T.event.approve).on("click" + R, A.deny, T.event.deny),
                ...
                showModal: function (t) {
                    t = e.isFunction(t) ? t : function () {},
                    T.is.animating() || !T.is.active() ? (T.showDimmer(), T.cacheSizes(), T.set.position(), T.set.screenHeight(), T.set.type(), T.set.clickaway(), !S.allowMultiple && T.others.active() ? T.hideOthers(T.showModal) : (S.onShow.call(N), S.transition && e.fn.transition !== i && P.transition("is supported") ? (T.debug("Showing modal with css animations"), P.transition({
                                    debug: S.debug,
                ...
                hideModal: function (t, n) {
                    ...
                    !1 === S.onHide.call(N, e(this)) ? void T.verbose("Hide callback returned false cancelling hide") : void((T.is.animating() || T.is.active()) && (S.transition && e.fn.transition !== i && P.transition("is supported") ? (T.remove.active(), P.transition({
                                    debug: S.debug,
        ...
        return r.each(function () {
            ...
            r = {
                initialize: function () {
                    ...
                    b.on("click" + m, p.close, r.dismiss).data(v, r),
                ...
                storage: {
                    set: function (n, o) {
                        ...
                        if ("localstorage" == f.storageMethod && t.localStorage !== i)
                            t.localStorage.setItem(n, o), r.debug("Value stored using local storage", n, o);
                        else if ("sessionstorage" == f.storageMethod && t.sessionStorage !== i)
                            t.sessionStorage.setItem(n, o), r.debug("Value stored using session storage", n, o);
                        else {
                            if (e.cookie === i)
                                return void r.error(g.noCookieStorage);
                            e.cookie(n, o, a),
                    ...
                    get: function (n, o) {
                        var a;
                        return "localstorage" == f.storageMethod && t.localStorage !== i ? a = t.localStorage.getItem(n) : "sessionstorage" == f.storageMethod && t.sessionStorage !== i ? a = t.sessionStorage.getItem(n) : e.cookie !== i ? a = e.cookie(n) : r.error(g.noCookieStorage),
                ...
                invoke: function (t, n, a) {
                    ...
                    e.isFunction(l) ? c = l.apply(a, n) : l !== i && (c = l),
...
(jQuery, window, document), function (e, t, n, i) {
    ...
    e.fn.popup = function (o) {
        ...
        return a.each(function () {
            ...
            x = {
                initialize: function () {
                    x.debug("Initializing", D),
                    x.createID(),
                    x.bind.events(),
                    !x.exists() && w.preserve && x.create(),
                    w.observeChanges && x.observeChanges(),
                    x.instantiate()
                },
                instantiate: function () {
                    x.verbose("Storing instance", x),
                    I = x,
                    D.data(j, I)
                },
                observeChanges: function () {
                ...
                refresh: function () {
                    w.popup ? a = e(w.popup).eq(0) : w.inline && (a = L.nextAll(C.popup).eq(0), w.popup = a),
                    w.popup ? (a.addClass(k.loading), m = x.get.offsetParent(), a.removeClass(k.loading), w.movePopup && x.has.popup() && x.get.offsetParent(a)[0] !== m[0] && (x.debug("Moving popup to the same offset parent as activating element"), a.detach().appendTo(m))) : m = w.inline ? x.get.offsetParent(L) : x.has.popup() ? x.get.offsetParent(a) : c,
                    m.is("html") && m[0] !== c[0] && (x.debug("Setting page as offset parent"), m = c),
                ...
                event: {
                    start: function (t) {
                        ...
                        clearTimeout(x.hideTimer),
                        F || (x.showTimer = setTimeout(x.show, n))
                    },
                    end: function () {
                ...
                toggle: function () {
                    ...
                    x.is.hidden() ? (x.debug("Popup is hidden, showing pop-up"), x.unbind.close(), x.show()) : (x.debug("Popup is visible, hiding pop-up"), x.hide())
                },
                show: function (e) {
                    if (e = e || function () {}, x.debug("Showing pop-up", w.transition), x.is.hidden() && (!x.is.active() || !x.is.dropdown())) {
                        if (x.exists() || x.create(), !1 === w.onShow.call(a, M))
                            return void x.debug("onShow callback returned false, cancelling popup animation");
                        w.preserve || w.popup || x.refresh(),
                        a && x.set.position() && (x.save.conditions(), w.exclusive && x.hideAll(), x.animate.show(e))
                    }
                },
                hide: function (e) {
                    if (e = e || function () {}, x.is.visible() || x.is.animating()) {
                        if (!1 === w.onHide.call(a, M))
                            return void x.debug("onHide callback returned false, cancelling popup animation");
                        x.remove.visible(),
                        x.unbind.close(),
                ...
                save: {
                    conditions: function () {
                        ...
                        x.cache.title && D.removeAttr("title"),
                        x.verbose("Saving original attributes", x.cache.title)
                    }
                },
                restore: {
                    conditions: function () {
                        return x.cache && x.cache.title && (D.attr("title", x.cache.title), x.verbose("Restoring original attributes", x.cache.title)),
                        !0
                    }
                },
                supports: {
                ...
                animate: {
                    show: function (t) {
                        t = e.isFunction(t) ? t : function () {},
                        w.transition && e.fn.transition !== i && D.transition("is supported") ? (x.set.visible(), a.transition({
                    ...
                    hide: function (t) {
                        ...
                        !1 === w.onHide.call(a, M) ? void x.debug("onHide callback returned false, cancelling popup animation") : void(w.transition && e.fn.transition !== i && D.transition("is supported") ? a.transition({
                ...
                get: {
                    html: function () {
                        return D.removeData(S.html),
                        D.data(S.html) || w.html
                    },
                    title: function () {
                        return D.removeData(S.title),
                        D.data(S.title) || w.title
                    },
                    content: function () {
                        return D.removeData(S.content),
                        D.data(S.content) || D.attr("title") || w.content
                    },
                    variation: function () {
                        return D.removeData(S.variation),
                        D.data(S.variation) || w.variation
                    },
                    popup: function () {
                        return a
                    },
                    ...
                    calculations: function () {
                        ...
                        s.target.margin.left = w.inline ? x.is.rtl() ? parseInt(t.getComputedStyle(n).getPropertyValue("margin-right"), 10) : parseInt(t.getComputedStyle(n).getPropertyValue("margin-left"), 10) : 0,
                        e = s.screen,
                        s.boundary = {
                    ...
                    offsetParent: function (t) {
                        ...
                        if (o)
                            for (var a = "none" === r.css("transform"), s = "static" === r.css("position"), l = r.is("html"); o && !l && s && a; )
                                o = o.parentNode, r = e(o), a = "none" === r.css("transform"), s = "static" === r.css("position"), l = r.is("html");
                    ...
                    nextPosition: function (e) {
                        ...
                        c = !1,
                        u = !1;
                        return N || (x.verbose("All available positions available"), N = x.get.positions()),
                        x.debug("Recording last position tried", e),
                        N[e] = !0,
                        "opposite" === w.prefer && (u = [o[n], i], u = u.join(" "), l = !0 === N[u], x.debug("Trying opposite strategy", u)),
                        "adjacent" === w.prefer && s && (u = [n, r[i]], u = u.join(" "), c = !0 === N[u], x.debug("Trying adjacent strategy", u)),
                        (c || l) && (x.debug("Using backup position", u), u = a[e]),
                        u
                    }
                },
                set: {
                    position: function (e, t) {
                        if (0 === L.length || 0 === a.length)
                            return void x.error(T.notFound);
                        var n,
                        o,
                        r,
                        s,
                        ...
                        u,
                        d;
                        if (t = t || x.get.calculations(), e = e || D.data(S.position) || w.position, n = D.data(S.offset) || w.offset, o = w.distanceAway, r = t.target, s = t.popup, l = t.parent, 0 === r.width && 0 === r.height && !x.is.svg(r.element))
                            return x.debug("Popup target is hidden, no action taken"), !1;
                        ...
                        if (c === i && x.error(T.invalidPosition, e), x.debug("Calculated popup positioning values", c), a.css(c).removeClass(k.position).addClass(e).addClass(k.loading), u = x.get.popupOffset(), d = x.get.distanceFromBoundary(u, t), x.is.offstage(d, e)) {
                            if (x.debug("Position is outside viewport", e), q < w.maxSearchDepth)
                                return q++, e = x.get.nextPosition(e), x.debug("Trying new position", e), !!a && x.set.position(e, t);
                            if (!w.lastResort)
                                return x.debug("Popup could not find a position to display", a), x.error(T.cannotPlace, M), x.remove.attempts(), x.remove.loading(), x.reset(), w.onUnplaceable.call(a, M), !1;
                            x.debug("No position found, showing with last position")
                        }
                        return x.debug("Position is on stage", e),
                        x.remove.attempts(),
                        x.remove.loading(),
                        w.setFluidWidth && x.is.fluid() && x.set.fluidWidth(t),
                        !0
                    },
                    fluidWidth: function (e) {
                        e = e || x.get.calculations(),
                        x.debug("Automatically setting element width to parent width", e.parent.width),
                ...
                bind: {
                    events: function () {
                        ...
                        "click" == w.on && D.on("click" + E, x.toggle),
                        "hover" == w.on && !0 && D.on("touchstart" + E, x.event.touchstart),
                        x.get.startEvent() && D.on(x.get.startEvent() + E, x.event.start).on(x.get.endEvent() + E, x.event.end),
                        w.target && x.debug("Target set to element", L),
                        l.on("resize" + b, x.event.resize)
                    },
                    popup: function () {
                        x.verbose("Allowing hover events on popup to prevent closing"),
                        a && x.has.popup() && a.on("mouseenter" + E, x.event.start).on("mouseleave" + E, x.event.end)
                    },
                    close: function () {
                        (!0 === w.hideOnScroll || "auto" == w.hideOnScroll && "click" != w.on) && O.one(x.get.scrollEvent() + b, x.event.hideGracefully),
                        "hover" == w.on && F && (x.verbose("Binding popup close event to document"), s.on("touchstart" + b, function (e) {
                ...
                reset: function () {
                    x.remove.visible(),
                    w.preserve ? e.fn.transition !== i && a.transition("remove transition") : x.removePopup()
                },
                setting: function (t, n) {
                    if (e.isPlainObject(t))
                        e.extend(!0, w, t);
        ...
        return r.each(function () {
            ...
            f = {
                ...
                read: {
                    ...
                    settings: function () {
                        !1 !== p.total && (f.debug("Current total set in settings", p.total), f.set.total(p.total)),
                        !1 !== p.value && (f.debug("Current value set in settings", p.value), f.set.value(p.value), f.set.progress(f.value)),
                        !1 !== p.percent && (f.debug("Current percent set in settings", p.percent), f.set.percent(p.percent))
                    }
                },
                bind: {
                ...
                increment: function (e) {
                    var t,
                    n;
                    f.has.total() ? (t = f.get.value(), e = e || 1, n = t + e) : (t = f.get.percent(), e = e || f.get.randomValue(), n = t + e, 100, f.debug("Incrementing percentage by", t, n)),
                ...
                decrement: function (e) {
                    var t,
                    n;
                    f.get.total() ? (t = f.get.value(), e = e || 1, n = t - e, f.debug("Decrementing value by", e, t)) : (t = f.get.percent(), e = e || f.get.randomValue(), n = t - e, f.debug("Decrementing percentage by", e, t)),
                    n = f.get.normalizedValue(n),
                    f.set.progress(n)
                },
                has: {
                ...
                remove: {
                    ...
                    success: function () {
                        ...
                        w.removeClass(g.success)
                    },
                    warning: function () {
                        f.verbose("Removing warning state"),
                        w.removeClass(g.warning)
                    },
                    error: function () {
                        f.verbose("Removing error state"),
                        w.removeClass(g.error)
                    }
                },
                set: {
                    barWidth: function (e) {
                    ...
                    labelInterval: function () {
                        ...
                        f.interval = setInterval(function () {
                            e.contains(n.documentElement, S) || (clearInterval(f.interval), E = !1),
                            f.set.labels()
                        }, p.framerate)
                    },
                    labels: function () {
                    ...
                    active: function (e) {
                        ...
                        p.showActivity && !f.is.active() && w.addClass(g.active),
                        f.remove.warning(),
                        f.remove.error(),
                        f.remove.success(),
            ...
            p = {
                ...
                bind: {
                    events: function () {
                        ...
                        g.automatic && (T.on(p.get.inputEvent() + C, y.prompt, p.event.input), S.attr("autocomplete", "off")),
                ...
                event: {
                    input: function () {
                        ...
                        p.timer = setTimeout(p.query, g.searchDelay)
                    },
                    focus: function () {
                        p.set.focus(),
                    ...
                    blur: function (e) {
                        ...
                        i = function () {
                            p.cancel.query(),
                            p.remove.focus(),
                            p.timer = setTimeout(p.hideResults, g.hideDelay)
                        };
                ...
                get: {
                    ...
                    result: function (t, n) {
                        ...
                        "category" === g.type ? (p.debug("Finding result that matches", t), e.each(n, function (n, i) {
                                if (e.isArray(i.results) && (r = p.search.object(t, i.results, o)[0]))
                                    return !1
                            })) : (p.debug("Finding result in results object", t), r = p.search.object(t, n, o)[0]),
                        r || !1
                    }
                },
                select: {
                ...
                set: {
                    ...
                    type: function (e) {
                        e = e || g.type,
                        "category" == g.type && T.addClass(g.type)
                    },
                ...
                search: {
                    ...
                    object: function (t, n, o) {
                        ...
                        e.isArray(o) || (o = [o]),
                        n === i || !1 === n ? (p.error(x.source), []) : (e.each(o, function (i, o) {
                ...
                create: {
                    id: function (e, t) {
                        ...
                        o,
                        r = e + 1;
                        return t !== i ? (n = String.fromCharCode(97 + t), o = n + r, p.verbose("Creating category result id", o)) : (o = r, p.verbose("Creating result id", o)),
                        o
                    },
                    results: function () {
                ...
                generateResults: function (t) {
                    ...
                    r = "";
                    return i || o ? (g.maxResults > 0 && (i ? "standard" == g.type && p.error(x.maxResults) : t[b.results] = t[b.results].slice(0, g.maxResults)), e.isFunction(n) ? r = n(t, b) : p.error(x.noTemplate, !1)) : g.showNoResults && (r = p.displayMessage(x.noResults, "empty")),
                ...
                displayMessage: function (e, t) {
                    ...
                    p.addResults(g.templates.message(e, t)),
    ...
    e.fn.search.settings = {
        ...
        templates: {
            ...
            category: function (t, n) {
                ...
                t[n.categoryResults] !== i && (e.each(t[n.categoryResults], function (t, r) {
            ...
            C = {
                ...
                bind: {
                    clickaway: function () {
                        ...
                        k.closable && P.on("click" + b, C.event.clickaway).on("touchend" + b, C.event.clickaway)
                    },
                    scrollLock: function () {
                        ...
                        O.on("scroll" + D, C.event.containScroll)
                    }
                },
                unbind: {
                    clickaway: function () {
                ...
                setup: {
                    ...
                    layout: function () {
                        0 === P.children(T.pusher).length && (C.debug("Adding wrapper element for sidebar"), C.error(j.pusher), N = e('<div class="pusher" />'), P.children().not(T.omitted).not(L).wrapAll(N), C.refresh()),
                        0 !== O.nextAll(T.pusher).length && O.nextAll(T.pusher)[0] === N[0] || (C.debug("Moved sidebar to correct parent element"), C.error(j.movedSidebar, F), O.detach().prependTo(P), C.refresh()),
                        C.clear.cache(),
                        C.set.pushable(),
                        C.set.direction()
                    }
                ...
                attachEvents: function (t, n) {
                    ...
                    i.length > 0 ? (C.debug("Attaching sidebar events to element", t, n), i.on("click" + D, n)) : C.error(j.notFound, t)
                },
                show: function (t) {
                ...
                get: {
                    ...
                    transition: function () {
                        var e,
                        t = C.get.direction();
                        return e = C.is.mobile() ? "auto" == k.mobileTransition ? k.defaultTransition.mobile[t] : k.mobileTransition : "auto" == k.transition ? k.defaultTransition.computer[t] : k.transition,
                ...
                is: {
                    ...
                    rtl: function () {
                        return C.cache.rtl === i && (C.cache.rtl = "rtl" == O.css("direction")),
                        C.cache.rtl
                    }
                },
                setting: function (t, n) {
                    ...
                    "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function (n, o) {
                            ...
                            if (e.isPlainObject(c[r]) && n != a)
                                ...
                                if (c[r] !== i)
                                    return s = c[r], !1;
                                if (!e.isPlainObject(c[o]) || n == a)
                                    return c[o] !== i ? (s = c[o], !1) : (C.error(j.method, t), !1);
                                c = c[o]
                            }
                        })),
                    e.isFunction(s) ? l = s.apply(o, n) : s !== i && (l = s),
        ...
        return a.each(function () {
            ...
            b = {
                ...
                determineTabs: function () {
                    var t;
                    "parent" === x.context ? (E.closest(k.ui).length > 0 ? (t = E.closest(k.ui), b.verbose("Using closest UI element as parent", t)) : t = E, g = t.parent(), b.verbose("Determined parent element for creating context", g)) : x.context ? (g = e(x.context), b.verbose("Using selector for tab context", x.context, g)) : g = e("body"),
                    x.childrenOnly ? (h = g.children(k.tabs), b.debug("Searching tab context children for tabs", g, h)) : (h = g.find(k.tabs), b.debug("Searching tab context for tabs", g, h))
                },
                fix: {
                    callbacks: function () {
                ...
                changeTab: function (n) {
                    ...
                    e.each(a, function (t, i) {
                        ...
                        if (b.verbose("Looking for tab", i), p) {
                            if (b.verbose("Tab was found", i), m = f, v = b.utilities.filterArray(a, d), h ? u = !0 : (l = a.slice(0, t + 2), c = b.utilities.arrayToPath(l), (u = !b.is.tab(c)) && b.verbose("Tab parameters found", l)), u && r)
                                return o ? (b.debug("Ignoring remote content on first tab load", f), D = !1, b.cache.add(n, k.html()), b.activate.all(f), x.onFirstLoad.call(k[0], f, v, y), x.onLoad.call(k[0], f, v, y)) : (b.activate.navigation(f), b.fetch.content(f, n)), !1;
                            ...
                            if (-1 != n.search("/") || "" === n)
                                return b.error(T.missingTab, E, g, f), !1;
                    ...
                    content: function (t, n) {
                        ...
                        s = {
                            ...
                            onSuccess: function (e) {
                                ...
                                t == m ? (b.debug("Content loaded", t), b.activate.tab(t)) : b.debug("Content loaded in background", t),
                ...
                get: {
                    ...
                    defaultPath: function (e) {
                        ...
                        n = t.data(C.tab) || !1;
                        if (n) {
                            if (b.debug("Found default tab", n), R < x.maxDepth)
                                return R++,
                                b.get.defaultPath(n);
                            b.error(T.recursion)
                        } else
                    ...
                    tabElement: function (e) {
                        ...
                        t = h.filter("[data-" + C.tab + '="' + e + '"]'),
                        n = h.filter("[data-" + C.tab + '="' + o + '"]'),
                        t.length > 0 ? t : n
                    },
                    tab: function () {
                        return m
        ...
        r.each(function (t) {
            ...
            w = {
                initialize: function () {
                    ...
                    f && (f = w.invoke(u)),
                    !1 === f && (w.verbose("Converted arguments into settings object", p), p.interval ? w.delay(p.animate) : w.animate(), w.instantiate())
                },
                instantiate: function () {
                ...
                animate: function (e) {
                    ...
                    if (w.debug("Preparing animation", p.animation), w.is.animating()) {
                        if (p.queue)
                            return !p.allowRepeats && w.has.direction() && w.is.occurring() && !0 !== w.queuing ? w.debug("Animation is currently occurring, preventing queueing same animation", p.animation) : w.queue(p.animation), !1;
                ...
                has: {
                    direction: function (t) {
                        ...
                        "string" == typeof t && (t = t.split(" "), e.each(t, function (e, t) {
                ...
                set: {
                    ...
                    duration: function (e, t) {
                        t = t || p.duration,
                        ((t = "number" == typeof t ? t + "ms" : t) || 0 === t) && (w.verbose("Setting animation duration", t), C.css({
                                "animation-duration": t
                            }))
                    },
                    direction: function (e) {
                        e = e || w.get.direction(),
                        e == m.inward ? w.set.inward() : w.set.outward()
                    },
                    looping: function () {
                        w.debug("Transition set to loop"),
                        C.addClass(m.looping)
                    },
                    hidden: function () {
                    ...
                    inward: function () {
                        ...
                        C.removeClass(m.outward).addClass(m.inward)
                    },
                    outward: function () {
                        w.debug("Setting direction to outward"),
                        C.removeClass(m.inward).addClass(m.outward)
                    },
                    visible: function () {
                ...
                remove: {
                    ...
                    looping: function () {
                        ...
                        w.is.looping() && (w.reset(), C.removeClass(m.looping))
                    },
                    transition: function () {
                ...
                get: {
                    ...
                    displayType: function (e) {
                        return e = e === i || e,
                        p.displayType ? p.displayType : (e && C.data(v.displayType) === i && w.can.transition(!0), C.data(v.displayType))
                    },
                    ...
                    transition: function (t) {
                        ...
                        if (u === i || t) {
                            if (w.verbose("Determining whether animation exists"), n = C.attr("class"), o = C.prop("tagName"), r = e("<" + o + " />").addClass(n).insertAfter(C), a = r.addClass(c).removeClass(m.inward).removeClass(m.outward).addClass(m.animating).addClass(m.transition).css("animationName"), s = r.addClass(m.inward).css("animationName"), d || (d = r.attr("class", n).removeAttr("style").removeClass(m.hidden).removeClass(m.visible).show().css("display"), w.verbose("Determining final display state", d), w.save.displayType(d)), r.remove(), a != s)
                                w.debug("Direction exists for animation", c), l = !0;
                            else {
                                if ("none" == a || !a)
                ...
                enable: function () {
                    ...
                    C.removeClass(m.disabled)
                },
                disable: function () {
                    w.debug("Stopping animation"),
                    C.addClass(m.disabled)
                },
                setting: function (t, n) {
        ...
        return r.each(function () {
            ...
            n = {
                    ...
                    state: function () {
                        ...
                        if (n.allows("active") && n.is.enabled()) {
                            if (n.refresh(), e.fn.api !== i)
                                if (t = w.api("get request"), w.api("was cancelled"))
                                    n.debug("API Request cancelled by beforesend"), f.activateTest = function () {
                                        return !1
                                    },
                ...
                invoke: function (t, r, a) {
                    ...
                    return r = r || d,
                    a = C || a,
                    "string" == typeof t && u !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (o, r) {
                    ...
                    e.isFunction(l) ? c = l.apply(a, r) : l !== i && (c = l),
                    e.isArray(o) ? o.push(c) : o !== i ? o = [o, c] : c !== i && (o = c),
                    l
                }
            },
    ...
    e.api = e.fn.api = function (n) {
        ...
        return r.each(function () {
            ...
            m = {
                ...
                destroy: function () {
                    m.verbose("Destroying previous module for", j),
                ...
                query: function () {
                    ...
                    f = m.get.settings(),
                    !1 === f ? (m.cancelled = !0, void m.error(w.beforeSend)) : (m.cancelled = !1, p = m.get.templatedURL(), p || m.is.mocked() ? (p = m.add.urlData(p), p || m.is.mocked() ? (f.url = v.base + p, r = e.extend(!0, {}, v, {
                                    ...
                                    complete: function () {}
                                            ...
                                            m.debug("Sending throttled request", g, r.method),
                                            m.send.request()
                ...
                add: {
                    ...
                    formData: function (t) {
                        ...
                        return t = t || v.data,
                        n = e.isPlainObject(t),
                        n ? o ? (m.debug("Extending existing data with form data", t, r), t = e.extend(!0, {}, t, r)) : (m.error(w.missingSerialize), m.debug("Cant extend data. Replacing data with form data", t, r), t = r) : (m.debug("Adding form data", r), t = r),
                        t
                    }
                },
                send: {
                    request: function () {
                        ...
                        v.onRequest.call(D, m.request, m.xhr)
                    }
                },
                event: {
                    trigger: function (e) {
                    ...
                    xhr: {
                        always: function () {},
                            ...
                            a = a > 0 ? a : 0,
                            s && (m.debug("Modified API response in onResponse callback", v.onResponse, s, t), t = s),
                        ...
                        fail: function (e, t, n) {
                            ...
                            r = r > 0 ? r : 0,
                            r > 0 && m.debug("Response completed early delaying state change by", r),
                            setTimeout(function () {
                    ...
                    request: {
                            ...
                            "local" === v.cache && p && (m.write.cachedResponse(p, e), m.debug("Saving server response locally", m.cache)),
                            v.onSuccess.call(D, e, S, t)
                        },
                        complete: function (e, t) {
                            var n,
                            i;
                            m.was.succesful() ? (i = e, n = t) : (n = e, i = m.get.responseFromXHR(n)),
                            m.remove.loading(),
                            v.onComplete.call(D, i, S, n)
                        },
                        fail: function (e, t, n) {
                ...
                create: {
                    ...
                    mockedXHR: function () {
                        ...
                        return i = e.Deferred().always(m.event.xhr.complete).done(m.event.xhr.done).fail(m.event.xhr.fail),
                        o ? (e.isFunction(o) ? (m.debug("Using specified synchronous callback", o), n = o.call(D, f)) : (m.debug("Using settings specified response", o), n = o), i.resolveWith(D, [n, !1, {
                                        responseText: n
                                    }
                                ])) : e.isFunction(r) && (t = function (e) {
                            m.debug("Async callback returned response", e),
                            e ? i.resolveWith(D, [e, !1, {
                                        responseText: e
                                    }
                                ]) : i.rejectWith(D, [{
                                        responseText: e
                                    }, !1, !1])
                        }, m.debug("Using specified async response callback", r), r.call(D, f, t)),
                        i
                    },
                    xhr: function () {
                        var t;
                        return t = e.ajax(r).always(m.event.xhr.always).done(m.event.xhr.done).fail(m.event.xhr.fail),
                        m.verbose("Created server request", t, r),
                        t
                    }
                },
                set: {
                    error: function () {
                        m.verbose("Adding error state to element", E),
                        E.addClass(C.error)
                    },
                    loading: function () {
                        m.verbose("Adding loading state to element", E),
                ...
                remove: {
                    error: function () {
                        m.verbose("Removing error state from element", E),
                        E.removeClass(C.error)
                    },
                    loading: function () {
                        m.verbose("Removing loading state from element", E),
                ...
                get: {
                    ...
                    settings: function () {
                        var t;
                        return t = v.beforeSend.call(D, v),
                        t && (t.success !== i && (m.debug("Legacy success callback detected", t), m.error(w.legacyParameters, t.success), t.onSuccess = t.success), t.failure !== i && (m.debug("Legacy failure callback detected", t), m.error(w.legacyParameters, t.failure), t.onFailure = t.failure), t.complete !== i && (m.debug("Legacy complete callback detected", t), m.error(w.legacyParameters, t.complete), t.onComplete = t.complete)),
                        t === i && m.error(w.noReturnedValue),
                        !1 === t ? t : t !== i ? e.extend(!0, {}, t) : e.extend(!0, {}, v)
                    },
                    ...
                    defaultData: function () {
                        var t = {};
                        return e.isWindow(j) || (m.is.input() ? t.value = S.val() : m.is.form() || (t.text = S.text())),
                        t
                    },
                    event: function () {
                    ...
                    templatedURL: function (e) {
                        if (e = e || S.data(y.action) || v.action || !1, p = S.data(y.url) || v.url || !1)
                            return m.debug("Using specified url", p), p;
                        if (e) {
                            if (m.debug("Looking up url for action", e, v.api), v.api[e] === i && !m.is.mocked())
                                return void m.error(w.missingAction, v.action, v.api);
                            p = v.api[e]
                        } else
                            m.is.form() && (p = S.attr("action") || E.attr("action") || !1, m.debug("No url or action specified, defaulting to form action", p));
                        return p
                    }
                },
                abort: function () {
                    ...
                    "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function (n, o) {
                            ...
                            if (e.isPlainObject(c[r]) && n != a)
                                ...
                                if (c[r] !== i)
                                    return s = c[r], !1;
                                if (!e.isPlainObject(c[o]) || n == a)
                                    return c[o] !== i ? (s = c[o], !1) : (m.error(w.method, t), !1);
                                c = c[o]
                            }
                        })),
                    e.isFunction(s) ? l = s.apply(r, n) : s !== i && (l = s),
...
(this, function () {
    ...
    function a(e, t, n) {
        for (var i in t)
            i in e ? "string" == typeof e[i] || e[i]instanceof String || "string" == typeof t[i] || t[i]instanceof String ? n && (e[i] = t[i]) : a(e[i], t[i], n) : e[i] = t[i];
        return e
    }
    function s(e) {
        return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
    ...
    function u(e) {
        ...
        e.ns && e.ns.defaultNs ? (e.defaultNS = e.ns.defaultNs, e.ns = e.ns.namespaces) : e.defaultNS = e.ns || "translation",
    ...
    function f(e) {
        return (e.interpolationPrefix || e.interpolationSuffix || e.escapeInterpolation) && (e = c(e)),
        e.nsSeparator = e.nsseparator,
        e.keySeparator = e.keyseparator,
        e.returnObjects = e.returnObjectTrees,
        e
    ...
    function p(e) {
        e.lng = function () {
            return j.deprecate("i18next.lng() can be replaced by i18next.language for detected language or i18next.languages for languages ordered by translation lookup."),
            e.services.languageUtils.toResolveHierarchy(e.language)[0]
        },
        e.preload = function (t, n) {
            j.deprecate("i18next.preload() can be replaced with i18next.loadLanguages()"),
            e.loadLanguages(t, n)
        },
        e.setLng = function (t, n, i) {
            return j.deprecate("i18next.setLng() can be replaced with i18next.changeLanguage() or i18next.getFixedT() to get a translation function with fixed language or namespace."),
            "function" == typeof n && (i = n, n = {}),
            n || (n = {}),
            !0 === n.fixLng && i ? i(null, e.getFixedT(t)) : void e.changeLanguage(t, i)
        },
        e.addPostProcessor = function (t, n) {
            j.deprecate("i18next.addPostProcessor() can be replaced by i18next.use({ type: 'postProcessor', name: 'name', process: fc })"),
            e.use({
                type: "postProcessor",
                name: t,
                process: n
    ...
    O = function (e) {
        ...
        t.prototype.getResource = function (e, t, n) {
            ...
            void 0 === o && (o = ".");
            var a = [e, t];
            return n && "string" != typeof n && (a = a.concat(n)),
        ...
        t.prototype.addResource = function (e, t, n, o) {
            ...
            e.indexOf(".") > -1 && (s = e.split("."), o = t, t = s[1]),
        ...
        t.prototype.addResources = function (e, t, n) {
            for (var i in n)
                "string" == typeof n[i] && this.addResource(e, t, i, n[i], {
                    silent: !0
                });
        ...
        t.prototype.addResourceBundle = function (e, t, n, o, s) {
            var l = [e, t];
            e.indexOf(".") > -1 && (l = e.split("."), o = n, n = t, t = l[1]),
            this.addNamespaces(t);
            var c = r(this.data, l) || {};
            o ? a(c, n, s) : c = C({}, c, n),
            i(this.data, l, c),
    ...
    L = function (e) {
        function n(i) {
            ...
            return t(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector"], i, r),
            r.options = o,
            r.logger = j.create("translator"),
            r
        }
        return k(n, e),
        n.prototype.changeLanguage = function (e) {
            e && (this.language = e)
        },
        n.prototype.exists = function (e) {
            ...
            return "v1" === this.options.compatibilityAPI && (t = f(t)),
        ...
        n.prototype.extractFromKey = function (e, t) {
            ...
            if (n && e.indexOf(n) > -1) {
                var r = e.split(n);
                (n !== i || n === i && this.options.ns.indexOf(r[0]) > -1) && (o = r.shift()),
                e = r.join(i)
            }
        ...
        n.prototype.translate = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            if ("object" !== (void 0 === t ? "undefined" : x(t)) ? t = this.options.overloadTranslationOptionHandler(arguments) : "v1" === this.options.compatibilityAPI && (t = f(t)), void 0 === e || null === e || "" === e)
                return "";
            ...
            if (c && "string" != typeof c && d.indexOf(u) < 0 && (!p || "[object Array]" !== u)) {
                if (!t.returnObjects && !this.options.returnObjects)
                    return this.logger.warn("accessing an object - but returnObjects options is not enabled!"), this.options.returnedObjectHandler ? this.options.returnedObjectHandler(o, c, t) : "key '" + o + " (" + this.language + ")' returned an object instead of string.";
                if (t.keySeparator || this.options.keySeparator) {
                    var g = "[object Array]" === u ? [] : {};
                    for (var h in c)
                        c.hasOwnProperty(h) && (g[h] = this.translate("" + o + n + h, C({}, t, {
                                        joinArrays: !1,
                                        ns: r
                                    })));
                    c = g
                ...
                (c = c.join(p)) && (c = this.extendTranslation(c, o, t));
            else {
                var m = !1,
                v = !1;
                if (this.isValidLookup(c) || void 0 === t.defaultValue || (m = !0, c = t.defaultValue), this.isValidLookup(c) || (v = !0, c = o), v || m) {
                    ...
                    this.options.saveMissing && (this.options.missingKeyHandler ? this.options.missingKeyHandler(b, a, o, c) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(b, a, o, c)),
                    this.emit("missingKey", b, a, o, c)
                }
                c = this.extendTranslation(c, o, t),
                v && c === o && this.options.appendNamespaceToMissingKey && (c = a + ":" + o),
                v && this.options.parseMissingKeyHandler && (c = this.options.parseMissingKeyHandler(c))
            }
            return c
        },
        n.prototype.extendTranslation = function (e, t, n) {
            ...
            this.options.interpolation.defaultVariables && (o = C({}, this.options.interpolation.defaultVariables, o)),
            e = this.interpolator.interpolate(e, o, this.language),
            ...
            return void 0 !== e && a && a.length && !1 !== n.applyPostProcessor && (e = P.handle(a, e, t, n, this)),
            e
        },
                    ...
                    a.forEach(function (e) {
                        t.isValidLookup(i) || c.forEach(function (o) {
                            if (!t.isValidLookup(i)) {
                                ...
                                c = [a],
                                u = void 0;
                                s && (u = t.pluralResolver.getSuffix(o, n.count)),
                                s && l && c.push(a + u),
                                l && c.push(a += "" + t.options.contextSeparator + n.context),
                                s && c.push(a += u);
                                for (var d = void 0; d = c.pop(); )
                                    t.isValidLookup(i) || (i = t.getResource(o, e, d, n))
                            }
                        })
                    })
                }
    ...
    q = function () {
        ...
        e.prototype.formatLanguageCode = function (e) {
            if ("string" == typeof e && e.indexOf("-") > -1) {
                ...
                }) : 2 === n.length ? (n[0] = n[0].toLowerCase(), n[1] = n[1].toUpperCase(), t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = g(n[1].toLowerCase()))) : 3 === n.length && (n[0] = n[0].toLowerCase(), 2 === n[1].length && (n[1] = n[1].toUpperCase()), "sgn" !== n[0] && 2 === n[2].length && (n[2] = n[2].toUpperCase()), t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = g(n[1].toLowerCase())), t.indexOf(n[2].toLowerCase()) > -1 && (n[2] = g(n[2].toLowerCase()))),
                n.join("-")
            }
            return this.options.cleanCode || this.options.lowerCaseLng ? e.toLowerCase() : e
        },
        e.prototype.isWhitelisted = function (e, t) {
            return ("languageOnly" === this.options.load || this.options.nonExplicitWhitelist && !t) && (e = this.getLanguagePartFromCode(e)),
        ...
        e.prototype.toResolveHierarchy = function (e, t) {
            ...
            return "string" == typeof e && e.indexOf("-") > -1 ? ("languageOnly" !== this.options.load && r(this.formatLanguageCode(e), !0), "languageOnly" !== this.options.load && "currentOnly" !== this.options.load && r(this.getScriptPartFromCode(e), !0), "currentOnly" !== this.options.load && r(this.getLanguagePartFromCode(e))) : "string" == typeof e && r(this.formatLanguageCode(e)),
    ...
    I = function () {
        ...
        return t.prototype.init = function () {
            ...
            arguments[1] && (this.options = e, this.format = e.interpolation && e.interpolation.format || function (e) {
                return e
            }, this.escape = e.interpolation && e.interpolation.escape || l),
        ...
        t.prototype.interpolate = function (t, n, i) {
            ...
            s = void 0,
            l = function (e) {
                if (e.indexOf(o.formatSeparator) < 0)
                    return r(n, e);
            ...
            for (; a = this.regexp.exec(t); )
                s = l(a[1].trim()), "string" != typeof s && (s = e(s)), s || (this.logger.warn("missed to pass in variable " + a[1] + " for interpolating " + t), s = ""), s = function (e) {
                    return e.replace(/\$/g, "$$$$")
                }
            (this.escapeValue ? this.escape(s) : s),
            t = t.replace(a[0], s),
        ...
        t.prototype.nest = function (t, n) {
            ...
            for (s.applyPostProcessor = !1; r = this.nestingRegexp.exec(t); )
                a = n(i.call(this, r[1].trim()), s), "string" != typeof a && (a = e(a)), a || (this.logger.warn("missed to pass in variable " + r[1] + " for interpolating " + t), a = ""), t = t.replace(r[0], a), this.regexp.lastIndex = 0;
            return t
        },
        t
    }
    ...
    H = function (e) {
        function t(n, i, o) {
            ...
            a.state = {},
            a.queue = [],
            a.backend && a.backend.init && a.backend.init(o, r.backend, r),
            a
        }
        return k(t, e),
        ...
        t.prototype.loaded = function (e, t, n) {
            ...
            s = a[0],
            l = a[1];
            t && this.emit("failedLoading", s, l, t),
            n && this.store.addResourceBundle(s, l, n),
            this.state[e] = t ? -1 : 2,
            this.queue.forEach(function (n) {
                o(n.loaded, [s], l),
                m(n.pending, e),
                t && n.errors.push(t),
                0 !== n.pending.length || n.done || (i.emit("loaded", n.loaded), n.errors.length ? n.callback(n.errors) : n.callback(), n.done = !0)
            }),
        ...
        t.prototype.read = function (e, t, n, i, o, r) {
            ...
            return i || (i = 0),
            o || (o = 250),
            e.length ? void this.backend[n](e, t, function (s, l) {
        ...
        t.prototype.load = function (e, t, n) {
            ...
            return a.toLoad.length ? void(o.allowMultiLoading && this.backend.readMulti ? this.read(a.toLoadLanguages, a.toLoadNamespaces, "readMulti", null, null, function (e, t) {
                    e && i.logger.warn("loading namespaces " + a.toLoadNamespaces.join(", ") + " for languages " + a.toLoadLanguages.join(", ") + " via multiloading failed", e),
                    !e && t && i.logger.log("loaded namespaces " + a.toLoadNamespaces.join(", ") + " for languages " + a.toLoadLanguages.join(", ") + " via multiloading", t),
                ...
                var e = function (e) {
                    ...
                    this.read(o, r, "read", null, null, function (n, i) {
                        n && t.logger.warn("loading namespace " + r + " for language " + o + " failed", n),
                        !n && i && t.logger.log("loaded namespace " + r + " for language " + o, i),
                        t.loaded(e, n, i)
                    })
                };
        ...
        t.prototype.reload = function (e, t) {
            ...
            "string" == typeof e && (e = this.services.languageUtils.toResolveHierarchy(e)),
            "string" == typeof t && (t = [t]),
            i.allowMultiLoading && this.backend.readMulti ? this.read(e, t, "readMulti", null, null, function (i, o) {
                i && n.logger.warn("reloading namespaces " + t.join(", ") + " for languages " + e.join(", ") + " via multiloading failed", i),
                !i && o && n.logger.log("reloaded namespaces " + t.join(", ") + " for languages " + e.join(", ") + " via multiloading", o),
                e.forEach(function (e) {
                    t.forEach(function (t) {
                        var a = r(o, [e, t]);
                        if (a)
                ...
                var i = function (e) {
                    ...
                    r = i[1];
                    this.read(o, r, "read", null, null, function (n, i) {
                        n && t.logger.warn("reloading namespace " + r + " for language " + o + " failed", n),
                        !n && i && t.logger.log("reloaded namespace " + r + " for language " + o, i),
                        t.loaded(e, n, i)
                    })
                };
                e.forEach(function (e) {
        ...
        t.prototype.saveMissing = function (e, t, n, i) {
            this.backend && this.backend.create && this.backend.create(e, t, n, i),
    ...
    $ = function (e) {
        function t(n, i, o) {
            ...
            a.services = o,
            a.options = r,
            a.logger = j.create("cacheConnector"),
            a.cache && a.cache.init && a.cache.init(o, r.cache, r),
            a
        }
        return k(t, e),
        t.prototype.load = function (e, t, n) {
    ...
    return new(function (e) {
        ...
        t.prototype.init = function (e, t) {
            function n(e) {
                if (e)
                    return "function" == typeof e ? new e : e
            }
            var i = this;
            if ("function" == typeof e && (t = e, e = {}), e || (e = {}), "v1" === e.compatibilityAPI ? this.options = C({}, v(), b(u(e)), {}) : "v1" === e.compatibilityJSON ? this.options = C({}, v(), b(d(e)), {}) : this.options = C({}, v(), this.options, b(e)), t || (t = y), !this.options.isClone) {
                ...
                r.resourceStore.on("added removed", function (e, t) {
                    r.cacheConnector.save()
                }),
                r.languageUtils = o,
                r.pluralResolver = new M(o, {
                    prepend: this.options.pluralSeparator,
                    compatibilityJSON: this.options.compatibilityJSON,
                    simplifyPluralSuffix: this.options.simplifyPluralSuffix
                }),
                r.interpolator = new I(this.options),
                r.backendConnector = new H(n(this.modules.backend), r.resourceStore, r, this.options),
                r.backendConnector.on("*", function (e) {
                ...
                r.cacheConnector = new $(n(this.modules.cache), r.resourceStore, r, this.options),
                r.cacheConnector.on("*", function (e) {
                    for (var t = arguments.length, n = Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++)
                        n[o - 1] = arguments[o];
                    i.emit.apply(i, [e].concat(n))
                }),
                this.modules.languageDetector && (r.languageDetector = n(this.modules.languageDetector), r.languageDetector.init(r, this.options.detection, this.options)),
        ...
        t.prototype.changeLanguage = function (e, t) {
            ...
            e && (this.language = e, this.languages = this.services.languageUtils.toResolveHierarchy(e), this.translator.changeLanguage(e), this.services.languageDetector && this.services.languageDetector.cacheUserLanguage(e)),
        ...
        t.prototype.cloneInstance = function () {
            ...
            r.translator = new L(r.services, r.options),
...
(this, function () {
    ...
    function n(e, n, i, o, r) {
        o && "object" === (void 0 === o ? "undefined" : l(o)) && (r || (o._t = new Date), o = t("", o).slice(1)),
        n.queryStringParams && (e = t(e, n.queryStringParams));
        try {
            var a;
            a = XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("MSXML2.XMLHTTP.3.0"),
            a.open(o ? "POST" : "GET", e, 1),
            n.crossDomain || a.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
            a.withCredentials = !!n.withCredentials,
            o && a.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
    ...
    u = function () {
        ...
        return c(t, [{
                    ...
                    value: function (t) {
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                        this.services = t,
                        this.options = e(n, this.options || {}, o())
                    }
                }, {
                    key: "readMulti",
                    value: function (e, t, n) {
...
var keyPlurals = {
    ...
    "/leaderboard": function () {
        function e() {
            ...
            window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + ("" != country ? "&country=" + encodeURI(country) : "") + "&relax=" + favouriteRelax + e.hash),
            api("leaderboard", {
                mode: favouriteMode,
                p: page,
                l: 50,
                ...
                n.find("tr").remove(),
                null == e.users && (disableSimplepagButtons(!0), e.users = []);
                var i = 0;
        ...
        page = 0 === page ? 1 : page,
        3 === favouriteMode && (favouriteRelax = 0, $("#relax-menu .item[data-relax=1]").addClass("disabled").removeClass("active"), $("#relax-menu .item[data-relax=0]").addClass("active")),		
        ...
        $("#mode-menu .item").click(function (t) {
            t.preventDefault(),
            $(this).hasClass("disabled") || ($("#mode-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteMode = $(this).data("mode"), 3 === favouriteMode ? (favouriteRelax = 0, $("#relax-menu .item[data-relax=1]").addClass("disabled").removeClass("active"), $("#relax-menu .item[data-relax=0]").addClass("active")) : $("#relax-menu .item[data-relax=1]").removeClass("disabled"), country = "", page = 1, e())
        }),
        $("#relax-menu .item").click(function (t) {
            t.preventDefault(),
            $(this).hasClass("disabled") || ($("#relax-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteRelax = $(this).data("relax"), page = 1, e())
    ...
    "/friends": function () {
        $(".smalltext.button").click(function () {
            ...
            api("friends/" + t, {
                ...
                e.data("deleted", t.friend ? "0" : "1"),
                e.removeClass("green red blue"),
                e.addClass(t.friend ? t.mutual ? "red" : "green" : "blue"),
                e.find(".icon").removeClass("minus plus heart").addClass(t.friend ? t.mutual ? "heart" : "minus" : "plus"),
                e.find("span").text(t.friend ? T(t.mutual ? "Mutual" : "Remove") : e("Add"))
            }, !0)
        })
    },
    "/team": function () {
    ...
    "/settings": function () {
        ...
        $("form").submit(function (t) {
            ...
            if (n != e) {
                ...
                i = n ? 1 | +i : -2 & +i,
                document.cookie = "cflags=" + i + ";path=/;max-age=31536000"
            }
            var o = formToObject($(this)),
            r = 0;
            $(this).find("input[data-sv]").each(function (e, t) {
                t = $(t),
                t.is(":checked") && (r |= t.data("sv"))
            }),
            o.play_style = r;
            var a = $(this);
    ...
    "/settings/scoreboard": function () {
        ...
        $("form").submit(function (e) {
            ...
            n = $(this);
            return api("users/self/scoreboard", t, function (e) {
                showMessage("success", "Your new settings have been saved."),
    ...
    "/settings/userpage": function () {
        ...
        $("textarea[name='data']").on("input", function () {
            ...
            e = setTimeout(function () {
                ...
                $.post("/settings/userpage/parse", $("textarea[name='data']").val(), function (e) {
    ...
    "/donate": function () {
        ...
        $.getJSON("/donate/rates", function (e) {
            ...
            n.on("update", function () {
                ...
                $("input[name='os0']").attr("value", (+e).toFixed(0) + " month" + (1 == e ? "" : "s")),
                $("#bitcoin-amt").text(o.toFixed(6)),
                $("#paypal-amt").val(i.toFixed(2))
            })
        }),
    ...
    "/beatmaps/rank_request": function () {
        function e(e) {
            $("#queue-info").html(e.submitted + "/" + e.queue_size),
            0 == e.submitted_by_user ? $("#by-you").attr("hidden", "hidden") : $("#by-you").removeAttr("hidden"),
            $("#submitted-by-user").text(e.submitted_by_user),
            $("#max-per-user").text(e.max_per_user);
            var t = (e.submitted / e.queue_size * 100).toFixed(0);
            $("#progressbar .progress").text(t + "%"),
        ...
        $("#b-form").submit(function (n) {
            ...
            o = t.exec(i);
            if (t.exec(), console.log(i, o), null === o)
                return showMessage("error", "Please provide a valid link, in the form of either https://osu.ppy.sh/s/&lt;ID&gt; or https://osu.ppy.sh/b/&lt;ID&gt;."), $(this).removeClass("loading"), !1;
            var r = {};
            ...
            return api("beatmaps/rank_requests", r, function (t) {
                ...
                a.removeClass("loading"),
                406 == e.code && showMessage("warning", "That beatmap is already ranked!")
            }, !0),
            !1
        })
    },
...
$(document).ready(function () {
    ...
    "function" == typeof e && e(),
    "function" == typeof deferredToPageLoad && deferredToPageLoad(),
    $("#user-search").search({
        onSelect: function (e) {
    ...
    $(document).keydown(function (e) {
        ...
        83 !== e.which && 115 !== e.which || n || ($("#user-search-input").focus(), e.preventDefault()),
        27 === e.which && n && t.blur()
    }),
    ...
    $("#language-selector .item").click(function () {
        ...
        document.cookie = "language=" + e + ";path=/;max-age=31536000",
...
var modsString = ["NF", "EZ", "NV", "HD", "HR", "SD", "DT", "RX", "HT", "NC", "FL", "AU", "SO", "AP", "PF", "K4", "K5", "K6", "K7", "K8", "K9", "RN", "LM", "K9", "K0", "K1", "K3", "K2"], langWhitelist = ["de", "it", "ko", "es", "ru", "pl", "fr", "nl", "sv", "fi", "ro", "ko", "vi"];
